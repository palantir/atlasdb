...
public final class DefaultNamespacedConjureTimelockService implements NamespacedConjureTimelockService {
    private static final AuthHeader AUTH_HEADER = AuthHeader.valueOf("Bearer omitted");
    private final String namespace;
    private final ConjureTimelockService conjureTimelockService;

    public DefaultNamespacedConjureTimelockService(ConjureTimelockService conjureTimelockService, String namespace) {
