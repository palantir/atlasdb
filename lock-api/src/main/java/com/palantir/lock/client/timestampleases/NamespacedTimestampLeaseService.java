...
public interface NamespacedTimestampLeaseService {
    NamespaceTimestampLeaseResponse acquireTimestampLeases(NamespaceTimestampLeaseRequest request);

    GetMinLeasedTimestampResponses getMinLeasedTimestamps(GetMinLeasedTimestampRequests request);
}
