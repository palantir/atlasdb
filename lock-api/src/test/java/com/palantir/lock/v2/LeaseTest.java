...
public class LeaseTest {
    ...
    public void shouldBeValidAfterCreation() {
        Lease lease = Lease.of(LeaderTime.of(LEADERSHIP_ID_1, time(10)), Duration.ofNanos(20));
    ...
    public void shouldBeInvalidRegardlessOfTimeIfLeaderIsChanged() {
        Lease lease = Lease.of(LeaderTime.of(LEADERSHIP_ID_1, time(10)), Duration.ofNanos(20L));
