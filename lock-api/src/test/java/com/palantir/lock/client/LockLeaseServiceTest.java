...
public class LockLeaseServiceTest {
    ...
    public void unlockShouldCallRemoteServer_validLeases() {
        ...
        verify(timelock)
                .unlockV2(ConjureUnlockRequestV2.of(ImmutableSet.of(
    ...
    public void shouldRefreshTheLease_invalidOnClient_validOnServer() {
        ...
        ConjureLockTokenV2 newLockToken = ConjureLockTokenV2.of(LOCK_TOKEN.getRequestId());

        when(timelock.refreshLocksV2(ConjureRefreshLocksRequestV2.of(ImmutableSet.of(newLockToken))))
                .thenReturn(ConjureRefreshLocksResponseV2.of(ImmutableSet.of(newLockToken), getLease()));

        Set<LockToken> refreshed = lockLeaseService.refreshLockLeases(ImmutableSet.of(leasedLockToken));
        verify(timelock).refreshLocksV2(ConjureRefreshLocksRequestV2.of(ImmutableSet.of(newLockToken)));
