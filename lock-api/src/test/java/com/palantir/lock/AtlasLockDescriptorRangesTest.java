...
public class AtlasLockDescriptorRangesTest {
    ...
    public void fullTableRangeContainsRowAndCellDescriptors() {
        ...
        assertThat(fullTable.contains(AtlasCellLockDescriptor.of(TABLE, BYTES, BYTES_SUFFIX))).isTrue();
    }
    ...
    public void fullTableRangeDoesNotContainOtherTableDescriptors() {
        ...
        assertThat(fullTable.contains(AtlasRowLockDescriptor.of(TABLE_2, BYTES))).isFalse();
        assertThat(fullTable.contains(AtlasCellLockDescriptor.of(TABLE_2, BYTES, BYTES_SUFFIX))).isFalse();
    }
    ...
    public void rowPrefixRangeContainsRowAndCellDescriptorsForRow() {
        ...
        assertThat(rowPrefix.contains(AtlasCellLockDescriptor.of(TABLE, BYTES, BYTES_SUFFIX))).isTrue();
    }
    ...
    public void rowPrefixRangeContainsRowAndCellDescriptorsForRowSuffix() {
        ...
        assertThat(rowPrefix.contains(AtlasRowLockDescriptor.of(TABLE, BYTES_SUFFIX))).isTrue();
        assertThat(rowPrefix.contains(AtlasCellLockDescriptor.of(TABLE, BYTES_SUFFIX, OTHER_BYTES))).isTrue();
    }
    ...
    public void rowPrefixRangeDoesNotContainRowAndCellDescriptorsForOtherRows() {
        ...
        assertThat(rowPrefix.contains(AtlasRowLockDescriptor.of(TABLE, OTHER_BYTES))).isFalse();
        assertThat(rowPrefix.contains(AtlasCellLockDescriptor.of(TABLE, OTHER_BYTES, OTHER_BYTES))).isFalse();
    }
    ...
    public void rowRangeContainsRowAndCellDescriptorsInRange() {
        ...
        assertThat(rowRange.contains(AtlasCellLockDescriptor.of(TABLE, BYTES, BYTES_SUFFIX))).isTrue();
        assertThat(rowRange.contains(AtlasRowLockDescriptor.of(TABLE, BYTES_SUFFIX))).isTrue();
        assertThat(rowRange.contains(AtlasCellLockDescriptor.of(TABLE, BYTES_SUFFIX, OTHER_BYTES))).isTrue();
    }
    ...
    public void rowRangeDoesNotContainEndRowOrCellDescriptors() {
        ...
        assertThat(rowRange.contains(AtlasRowLockDescriptor.of(TABLE, OTHER_BYTES))).isFalse();
        assertThat(rowRange.contains(AtlasCellLockDescriptor.of(TABLE, OTHER_BYTES, BYTES_SUFFIX))).isFalse();
    }
    ...
    public void exactRowDoesNotContainCellDescriptorForRow() {
        ...
        assertThat(exactRow.contains(AtlasCellLockDescriptor.of(TABLE, BYTES, BYTES_SUFFIX))).isFalse();
    }
    ...
    public void exactRowDoesNotContainRowDescriptorForOtherRows() {
        ...
        assertThat(exactRow.contains(AtlasRowLockDescriptor.of(TABLE, BYTES_SUFFIX))).isFalse();
        assertThat(exactRow.contains(AtlasRowLockDescriptor.of(TABLE, OTHER_BYTES))).isFalse();
    }
    ...
    public void exactCellContainsCellDescriptor() {
        ...
        assertThat(exactCell.contains(AtlasCellLockDescriptor.of(TABLE, BYTES, BYTES))).isTrue();
    }
    ...
    public void exactCellDoesNotContainRowDescriptors() {
        ...
        assertThat(exactCell.contains(AtlasRowLockDescriptor.of(TABLE, BYTES_SUFFIX))).isFalse();
    }
    ...
    public void exactCellDoesNotContainOtherCellDescriptors() {
        ...
        assertThat(exactCell.contains(AtlasCellLockDescriptor.of(TABLE, BYTES, BYTES_SUFFIX))).isFalse();
        assertThat(exactCell.contains(AtlasCellLockDescriptor.of(TABLE, BYTES_SUFFIX, BYTES))).isFalse();
    }
}
