...
public final class LevelDbKeyValuePerfTest {
    ...
    public void setUp() throws IOException {
		final File dbPath = getDatabasePath();
		factory = LevelDbKeyValueService.getDBFactory();
        factory.destroy(dbPath, new Options());
        final Options options = new Options();
//        options.blockSize(1<<10);
//        options.cache(new Cache(100<<20));
//        options.writeBufferSize(1<<20);
        options.createIfMissing(true);
        db = LevelDbKeyValueService.create(options, dbPath);
    }
    ...
    public void tearDown() throws IOException {
		...
		factory.destroy(getDatabasePath(), new Options());
    }
