...
@JsonSubTypes({
    @JsonSubTypes.Type(
            value = CassandraWireKeyValueServiceRuntimeConfig.class,
            name = "CassandraWireKeyValueServiceRuntimeConfig"), // Deprecated, kept for backwards compatibility
    @JsonSubTypes.Type(
            value = CassandraWireKeyValueServiceRuntimeConfig.class,
            name = CassandraWireKeyValueServiceRuntimeConfig.TYPE)
})
@Value.Immutable
public abstract class CassandraWireKeyValueServiceRuntimeConfig implements KeyValueServiceRuntimeConfig {
