...
public class TransactionsTableRepairRangeFetcher {
    private static final SafeLogger log = SafeLoggerFactory.get(TransactionsTableRepairRangeFetcher.class);

    private final CqlSession cqlSession;

    public TransactionsTableRepairRangeFetcher(CqlSession cqlSession) {
        this.cqlSession = cqlSession;
    }

    public Map<String, Map<InetSocketAddress, RangeSet<LightweightOppToken>>> getTransactionsTableRangesForRepair(
            CassandraKeyValueServiceConfig config, List<TransactionsTableInteraction> transactionsTableInteractions) {
