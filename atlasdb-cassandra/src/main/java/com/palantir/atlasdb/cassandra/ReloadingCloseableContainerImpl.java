 ...
 * closed.
 */
public final class ReloadingCloseableContainerImpl<T extends AutoCloseable> implements ReloadingCloseableContainer<T> {
    ...
    private <K> ReloadingCloseableContainerImpl(Refreshable<K> refreshableParameter, Function<K, T> factory) {
        this.isClosed = false;
    ...
    public static <T extends AutoCloseable, K> ReloadingCloseableContainerImpl<T> of(
