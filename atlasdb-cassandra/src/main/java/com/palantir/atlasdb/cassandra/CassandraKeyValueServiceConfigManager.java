...
public final class CassandraKeyValueServiceConfigManager {
    ...
    public static CassandraKeyValueServiceConfigManager createSimpleManager(
            CassandraKeyValueServiceConfig config) {
        return createSimpleManager(config, Optional::empty);
    }

    public static CassandraKeyValueServiceConfigManager createSimpleManager(
            CassandraKeyValueServiceConfig config,
            java.util.function.Supplier<Optional<CassandraKeyValueServiceRuntimeConfig>> runtimeConfig) {
