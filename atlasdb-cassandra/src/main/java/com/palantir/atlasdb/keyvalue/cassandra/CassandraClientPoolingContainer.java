...
public class CassandraClientPoolingContainer implements PoolingContainer<CassandraClient> {
    ...
    private final Timer getResourceTimer;
    ...
    public CassandraClientPoolingContainer(
        ...
        getResourceTimer = metricsManager.registerOrGetTimer(CassandraClientPoolingContainer.class, "getResource");
    ...
    private CassandraClient getResource() throws Exception {
        try (Timer.Context timer = getResourceTimer.time();
                CloseableTracer trace =
