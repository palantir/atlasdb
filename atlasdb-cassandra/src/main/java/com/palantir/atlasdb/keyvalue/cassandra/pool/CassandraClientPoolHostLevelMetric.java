...
public enum CassandraClientPoolHostLevelMetric {
    MEAN_ACTIVE_TIME_MILLIS("meanActiveTimeMillis", 0.0, 999999),
    NUM_IDLE("numIdle", 0.0, 999999),
    NUM_ACTIVE("numActive", 0.0, 999999),
    CREATED("created", 0.0, 999999),
    DESTROYED_BY_EVICTOR("destroyedByEvictor", 0.0, 999999),
    DESTROYED("destroyed", 0.0, 999999);
