...
public class KeyValueServiceModule {
    ...
    @Provides
    @Singleton
    public CoordinationService<InternalSchemaMetadata> provideCoordinationService(
            @Named("kvs") KeyValueService kvs,
            TimestampService timestampService,
            ServicesConfig config) {
        return CoordinationServices.createDefault(kvs, timestampService, config.atlasDbConfig().initializeAsync());
    }
