...
public final class AtlasDbHttpClients {
    ...
    public static <T> T createProxy(
        ...
        return AtlasDbMetrics.instrument(
                metricRegistry,
                type,
                DEFAULT_TARGET_FACTORY.createProxy(trustContext, Optional.empty(), uri, type, userAgent, limitPayloadSize),
    ...
    public static <T> T createProxyWithoutRetrying(
        ...
        return AtlasDbMetrics.instrument(
                metricRegistry,
                type,
                DEFAULT_TARGET_FACTORY.createProxyWithoutRetrying(trustContext, Optional.empty(), uri, type, userAgent, limitPayloadSize),
                MetricRegistry.name(type));
    }
