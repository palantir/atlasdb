...
public class AsyncTimelockResource {
     ...
     *
     * It is guaranteed to have at least one timestamp in the returned timestamp range, but there is no other guarantee
     * given. (It can be less than number of requested timestamps)
     */
    @POST
