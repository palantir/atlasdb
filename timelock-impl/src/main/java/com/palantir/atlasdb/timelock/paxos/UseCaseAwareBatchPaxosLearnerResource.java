...
public final class UseCaseAwareBatchPaxosLearnerResource {
    ...
    public void learn(@PathParam("useCase") PaxosUseCase useCase, SetMultimap<Client, PaxosValue> paxosValuesByClient) {
    ...
    public SetMultimap<Client, PaxosValue> getLearnedValues(
            @PathParam("useCase") PaxosUseCase useCase, Set<WithSeq<Client>> clientAndSeqs) {
    ...
    public SetMultimap<Client, PaxosValue> getLearnedValuesSince(
            @PathParam("useCase") PaxosUseCase useCase, Map<Client, Long> seqLowerBoundsByClient) {
