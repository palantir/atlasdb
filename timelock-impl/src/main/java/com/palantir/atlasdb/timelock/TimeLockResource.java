...
public class TimeLockResource {
    ...
    private final Supplier<Integer> maxNumberOfNamespaces;

    public TimeLockResource(
            Function<String, TimeLockServices> clientServicesFactory,
            Supplier<Integer> maxNumberOfNamespaces) {
        this.clientServicesFactory = clientServicesFactory;
        this.maxNumberOfNamespaces = maxNumberOfNamespaces;
    }
    ...
    private TimeLockServices createNewClient(String namespace) {
        ...
        if (servicesByNamespace.size() >= maxNumberOfNamespaces.get()) {
            log.error(
                    ...
                    SafeArg.of("maxNumberOfNamespaces", maxNumberOfNamespaces));
