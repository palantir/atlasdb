...
public class StreamTables {
    ...
    public static final String HASH_TABLE_SUFFIX = "_stream_hash_aidx";
    ...
    public static void generateSchema(Schema schema, final String shortPrefix, final String longPrefix, final ValueType idType) {
        ...
        schema.addTableDefinition(shortPrefix + HASH_TABLE_SUFFIX, getStreamHashAidxDefinition(longPrefix, idType, ExpirationStrategy.NEVER));
    ...
    public static TableDefinition getStreamHashAidxDefinition(final String longPrefix,
                                                              final ValueType idType,
                                                              final ExpirationStrategy expirationStrategy) {
        return new TableDefinition() {{
