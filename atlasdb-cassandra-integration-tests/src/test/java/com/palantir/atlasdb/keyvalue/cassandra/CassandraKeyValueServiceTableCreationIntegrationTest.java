...
public class CassandraKeyValueServiceTableCreationIntegrationTest {
    ...
    public void setUp() {
        ...
        kvs = CassandraTestTools.createKeyValueServiceWithInMemoryTimestampService(
                quickTimeoutConfig,
        ...
        slowTimeoutKvs = CassandraTestTools.createKeyValueServiceWithInMemoryTimestampService(
                slowTimeoutConfig,
                CassandraContainer.LEADER_CONFIG);
