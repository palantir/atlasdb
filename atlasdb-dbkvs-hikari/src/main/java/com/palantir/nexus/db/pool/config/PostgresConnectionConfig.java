...
public abstract class PostgresConnectionConfig extends ConnectionConfig {
    ...
    public Properties getHikariProperties() {
        ...
        // As per https://github.com/pgjdbc/pgjdbc/issues/1307, we need to replace "ssl: true" with
        // "sslmode: require"
        // (introduced in https://github.com/pgjdbc/pgjdbc/commit/cdeeaca47dc3bc6f727c79a582c9e4123099526e)
