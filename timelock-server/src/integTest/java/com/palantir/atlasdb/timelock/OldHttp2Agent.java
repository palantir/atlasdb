...
public final class OldHttp2Agent {
    private OldHttp2Agent() {}

    private static final Logger log = LoggerFactory.getLogger(OldHttp2Agent.class);
    ...
    public static synchronized void install() {
        ...
        try {
            AgentLoader.loadAgentClass(OldHttp2Agent.class.getName(), "");
