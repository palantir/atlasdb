...
public class TestPaxosTimeLockServer extends PaxosTimeLockServer{
    public TestPaxosTimeLockServer(PaxosConfiguration configuration,
    ...
    public TimeLockServices createInvalidatingTimeLockServices(String client) {
        ...
        LockService lockService = instrument(
                ...
                AwaitingLeadershipProxy.newProxyInstance(
                        LockService.class,
                        () -> RateLimitingLockService.TestSlowRateLimitingService.create(LockServiceImpl.create(), availableThreads, numClients),
