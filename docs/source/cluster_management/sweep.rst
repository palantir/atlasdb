...
If subsequent KVS round-trips are successful, the value of ``candidateBatchHint`` is slowly increased back to the configured maximum. Therefore, if the maximum is too high, failures will happen again.
