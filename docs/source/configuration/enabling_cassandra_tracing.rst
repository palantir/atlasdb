...
To enable tracing you need to provide a configraiton file called 
...
.. code:: properties
    ...
    min_duration_to_log_ms: 1000    # when a query is traced the minimum amount of time it has to take for us to actually log it
