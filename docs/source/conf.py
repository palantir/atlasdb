...
def get_last_release_from_gradle():
  ...
  For example, if we are currently on version v0.23.0-g67266dd, this function
  will return "0.23.0".
...
release = version
# The last version released from this repo
last_release = get_last_release_from_gradle()
