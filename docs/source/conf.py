# -*- coding: utf-8 -*-
#
# AtlasDB documentation build configuration file, created by
...
def get_version_from_gradle():
  ...
  Parses the output of ./gradlew printVersion in order to get the current
  version of the repository. We are assuming that this file is two directories
  up from the codebase root, and the version is the line after ':printVersion'
  in the stdout of the gradle command.
  ...
  p = subprocess.Popen(['./gradlew', 'printVersion'],
                       cwd=codebase_root, stdout=subprocess.PIPE)
  stdout = p.communicate()[0]
  lines = stdout.split('\n')
  return lines[lines.index(':printVersion') + 1]
