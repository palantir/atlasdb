...
To compile, for instance, the .proto files in examples/profile-client,
you do

    proto/compile.sh examples/profile-client
...
PROTOC=~/usr/src/protobuf-2.6.1/src/protoc proto/compile.sh examples/profile-client
