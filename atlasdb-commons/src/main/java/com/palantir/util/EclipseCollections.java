...
public final class EclipseCollections {
    ...
    /**
     * Classes to initialize early from eclipse-collections 11.1.0.
     */
    @VisibleForTesting
    static final List<String> CLASSES_TO_INITIALIZE = List.of(
    ...
    private static void initializeClass(String name) {
        try {
            ...
            log.debug("Initialized class", SafeArg.of("class", name));
