...
public final class StreamTestWithHashStreamStore extends AbstractPersistentStreamStore {
  ...
  public static final int IN_MEMORY_THRESHOLD =
      4000; // streams under this size are kept in memory when loaded
  ...
  private StreamTestWithHashStreamStore(
      TransactionManager txManager, StreamTestTableFactory tables) {
    super(txManager);
    this.tables = tables;
  }

  public static StreamTestWithHashStreamStore of(
      TransactionManager txManager, StreamTestTableFactory tables) {
  ...
  protected void storeBlock(Transaction t, long id, long blockNumber, final byte[] block) {
    ...
    final StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow row =
        StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow.of(id, blockNumber);
    try {
  ...
  private void touchMetadataWhileStoringForConflicts(Transaction t, Long id, long blockNumber) {
    StreamTestWithHashStreamMetadataTable metaTable =
        tables.getStreamTestWithHashStreamMetadataTable(t);
    StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow row =
        StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow.of(id);
  ...
  protected void putMetadataAndHashIndexTask(
    ...
    StreamTestWithHashStreamMetadataTable mdTable =
        tables.getStreamTestWithHashStreamMetadataTable(t);
    Map<Long, StreamMetadata> prevMetadatas = getMetadata(t, streamIdsToMetadata.keySet());

    Map<StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow, StreamMetadata>
    ...
    for (Entry<Long, StreamMetadata> e : streamIdsToMetadata.entrySet()) {
      ...
      if (metadata.getStatus() == Status.STORED) {
        ...
        rowsToStoredMetadata.put(
            StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow.of(streamId),
            metadata);
  ...
  protected void loadSingleBlockToOutputStream(
    ...
    StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow row =
        StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow.of(streamId, blockId);
    try {
  ...
  private byte[] getBlock(
      Transaction t, StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow row) {
  ...
  public Map<Sha256Hash, Long> lookupStreamIdsByHash(Transaction t, final Set<Sha256Hash> hashes) {
    ...
    Set<StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow> rows =
    ...
    for (StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow r : m.keySet()) {
      for (StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumnValue v :
          m.get(r)) {
  ...
  private Set<StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow>
      getHashIndexRowsForHashes(final Set<Sha256Hash> hashes) {
    Set<StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow> rows =
        Sets.newHashSet();
  ...
  private Set<StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow>
      getMetadataRowsForIds(final Iterable<Long> ids) {
    Set<StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow> rows =
        Sets.newHashSet();
    for (Long id : ids) {
  ...
  private void putHashIndexTask(
    ...
    for (Entry<
      ...
      StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow hashRow =
          StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow.of(hash);
      StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumn column =
          StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumn.of(
              row.getId());
      StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumnValue
          columnValue =
              StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumnValue.of(
                  column, 0L);
      indexMap.put(hashRow, columnValue);
    }
    StreamTestWithHashStreamHashAidxTable hiTable =
        tables.getStreamTestWithHashStreamHashAidxTable(t);
  ...
  void deleteStreams(Transaction t, final Set<Long> streamIds) {
    ...
    Set<StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow> smRows =
        Sets.newHashSet();
    Multimap<
            StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow,
    ...
    Set<StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow> streamValueToDelete =
        Sets.newHashSet();
    for (Entry<
            StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow,
            StreamMetadata>
      ...
      for (long i = 0; i < blocks; i++) {
        streamValueToDelete.add(
            StreamTestWithHashStreamValueTable.StreamTestWithHashStreamValueRow.of(streamId, i));
      }
      ...
      StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow hashRow =
          StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxRow.of(hash);
      StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumn column =
          StreamTestWithHashStreamHashAidxTable.StreamTestWithHashStreamHashAidxColumn.of(streamId);
  ...
  protected void markStreamsAsUsedInternal(
    ...
    for (Map.Entry<Long, byte[]> entry : streamIdsToReference.entrySet()) {
      ...
      StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxColumn col =
          StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxColumn.of(reference);
      StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxColumnValue value =
          StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxColumnValue.of(col, 0L);
      rowsToValues.put(
          StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxRow.of(streamId), value);
    }
  ...
  public void unmarkStreamsAsUsed(Transaction t, final Map<Long, byte[]> streamIdsToReference) {
    ...
    for (Map.Entry<Long, byte[]> entry : streamIdsToReference.entrySet()) {
      ...
      StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxColumn col =
          StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxColumn.of(reference);
      toDelete.put(
          StreamTestWithHashStreamIdxTable.StreamTestWithHashStreamIdxRow.of(streamId), col);
    }
  ...
  protected void touchMetadataWhileMarkingUsedForConflicts(Transaction t, Iterable<Long> ids) {
    ...
    Map<StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow, StreamMetadata>
        metadatas = metaTable.getMetadatas(rows);
    for (Map.Entry<
            StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow,
            StreamMetadata>
        e : metadatas.entrySet()) {
    ...
    SetView<StreamTestWithHashStreamMetadataTable.StreamTestWithHashStreamMetadataRow> missingRows =
