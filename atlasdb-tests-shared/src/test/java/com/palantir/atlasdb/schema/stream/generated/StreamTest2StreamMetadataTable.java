...
public final class StreamTest2StreamMetadataTable implements
    ...
    static StreamTest2StreamMetadataTable of(Transaction t, StreamTest2StreamMetadataTrigger trigger, StreamTest2StreamMetadataTrigger... triggers) {
        return new StreamTest2StreamMetadataTable(t, ImmutableList.<StreamTest2StreamMetadataTrigger>builder().add(trigger).add(triggers).build());
    }

    static StreamTest2StreamMetadataTable of(Transaction t, List<StreamTest2StreamMetadataTrigger> triggers) {
        return new StreamTest2StreamMetadataTable(t, triggers);
    }

    private StreamTest2StreamMetadataTable(Transaction t, List<StreamTest2StreamMetadataTrigger> triggers) {
        this.t = t;
        ...
        public static Function<Long, StreamTest2StreamMetadataRow> fromIdFun() {
            return new Function<Long, StreamTest2StreamMetadataRow>() {
                ...
                public StreamTest2StreamMetadataRow apply(Long row) {
                    return new StreamTest2StreamMetadataRow(row);
                }
            };
        }
