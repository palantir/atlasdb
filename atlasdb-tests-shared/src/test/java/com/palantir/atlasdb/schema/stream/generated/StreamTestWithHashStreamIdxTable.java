...
public final class StreamTestWithHashStreamIdxTable
  ...
  private static final String rawTableName = "stream_test_with_hash_stream_idx";
  ...
  static StreamTestWithHashStreamIdxTable of(Transaction t, Namespace namespace) {
    return new StreamTestWithHashStreamIdxTable(
        t, namespace, ImmutableList.<StreamTestWithHashStreamIdxTrigger>of());
  }

  static StreamTestWithHashStreamIdxTable of(
      Transaction t,
      Namespace namespace,
      StreamTestWithHashStreamIdxTrigger trigger,
      StreamTestWithHashStreamIdxTrigger... triggers) {
    return new StreamTestWithHashStreamIdxTable(
        t,
        namespace,
        ImmutableList.<StreamTestWithHashStreamIdxTrigger>builder()
            .add(trigger)
            .add(triggers)
            .build());
  }
  ...
  static StreamTestWithHashStreamIdxTable of(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamIdxTrigger> triggers) {
    return new StreamTestWithHashStreamIdxTable(t, namespace, triggers);
  }

  private StreamTestWithHashStreamIdxTable(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamIdxTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamIdxRow
      implements Persistable, Comparable<StreamTestWithHashStreamIdxRow> {
    private final long firstComponentHash;
    private final long id;

    public static StreamTestWithHashStreamIdxRow of(long id) {
      long firstComponentHash =
          Hashing.murmur3_128().hashBytes(ValueType.VAR_LONG.convertFromJava(id)).asLong();
    ...
    public static final Hydrator<StreamTestWithHashStreamIdxRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestWithHashStreamIdxRow>() {
          @Override
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamIdxColumn
      implements Persistable, Comparable<StreamTestWithHashStreamIdxColumn> {
    ...
    public static final Hydrator<StreamTestWithHashStreamIdxColumn> BYTES_HYDRATOR =
        new Hydrator<StreamTestWithHashStreamIdxColumn>() {
          @Override
  ...
  public interface StreamTestWithHashStreamIdxTrigger {
    public void putStreamTestWithHashStreamIdx(
        Multimap<StreamTestWithHashStreamIdxRow, ? extends StreamTestWithHashStreamIdxColumnValue>
            newRows);
  }
  ...
  public static final class StreamTestWithHashStreamIdxColumnValue implements ColumnValue<Long> {
    ...
    public static StreamTestWithHashStreamIdxColumnValue of(
        StreamTestWithHashStreamIdxColumn columnName, Long value) {
      return new StreamTestWithHashStreamIdxColumnValue(columnName, value);
    }

    private StreamTestWithHashStreamIdxColumnValue(
        StreamTestWithHashStreamIdxColumn columnName, Long value) {
    ...
    public static Function<
            StreamTestWithHashStreamIdxColumnValue, StreamTestWithHashStreamIdxColumn>
        getColumnNameFun() {
      return new Function<
          StreamTestWithHashStreamIdxColumnValue, StreamTestWithHashStreamIdxColumn>() {
        @Override
        public StreamTestWithHashStreamIdxColumn apply(
            StreamTestWithHashStreamIdxColumnValue columnValue) {
  ...
  public static final class StreamTestWithHashStreamIdxRowResult implements TypedRowResult {
    ...
    public static StreamTestWithHashStreamIdxRowResult of(RowResult<byte[]> rowResult) {
      StreamTestWithHashStreamIdxRow rowName =
          StreamTestWithHashStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(rowResult.getRowName());
      Set<StreamTestWithHashStreamIdxColumnValue> columnValues =
          Sets.newHashSetWithExpectedSize(rowResult.getColumns().size());
      for (Entry<byte[], byte[]> e : rowResult.getColumns().entrySet()) {
        StreamTestWithHashStreamIdxColumn col =
            StreamTestWithHashStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
    ...
    private StreamTestWithHashStreamIdxRowResult(
        StreamTestWithHashStreamIdxRow rowName,
        ImmutableSet<StreamTestWithHashStreamIdxColumnValue> columnValues) {
    ...
    public static Function<StreamTestWithHashStreamIdxRowResult, StreamTestWithHashStreamIdxRow>
        getRowNameFun() {
      return new Function<StreamTestWithHashStreamIdxRowResult, StreamTestWithHashStreamIdxRow>() {
        @Override
        public StreamTestWithHashStreamIdxRow apply(
            StreamTestWithHashStreamIdxRowResult rowResult) {
    ...
    public static Function<
            StreamTestWithHashStreamIdxRowResult,
            ImmutableSet<StreamTestWithHashStreamIdxColumnValue>>
        getColumnValuesFun() {
      return new Function<
          StreamTestWithHashStreamIdxRowResult,
          ImmutableSet<StreamTestWithHashStreamIdxColumnValue>>() {
        @Override
        public ImmutableSet<StreamTestWithHashStreamIdxColumnValue> apply(
            StreamTestWithHashStreamIdxRowResult rowResult) {
  ...
  public void delete(Iterable<StreamTestWithHashStreamIdxRow> rows) {
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> toRemove =
        HashMultimap.create();
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> result =
        getRowsMultimap(rows);
    for (Entry<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> e :
        result.entries()) {
  ...
  @Override
  public void delete(
      Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> values) {
  ...
  public void put(
      StreamTestWithHashStreamIdxRow rowName,
      Iterable<StreamTestWithHashStreamIdxColumnValue> values) {
    put(
        ImmutableMultimap
            .<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>builder()
  ...
  @Override
  public void put(
      StreamTestWithHashStreamIdxRow rowName, StreamTestWithHashStreamIdxColumnValue... values) {
    put(
        ImmutableMultimap
            .<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>builder()
            .putAll(rowName, values)
  ...
  public void putUnlessExists(
      Multimap<StreamTestWithHashStreamIdxRow, ? extends StreamTestWithHashStreamIdxColumnValue>
          rows) {
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> toGet =
        Multimaps.transformValues(rows, StreamTestWithHashStreamIdxColumnValue.getColumnNameFun());
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> existing =
        get(toGet);
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> toPut =
        HashMultimap.create();
    for (Entry<StreamTestWithHashStreamIdxRow, ? extends StreamTestWithHashStreamIdxColumnValue>
        entry : rows.entries()) {
  ...
  public void touch(
      Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> values) {
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> currentValues =
        get(values);
    put(currentValues);
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> toDelete =
        HashMultimap.create(values);
    for (Map.Entry<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> e :
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestWithHashStreamIdxColumn> cols) {
  ...
  @Override
  public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> get(
      Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> cells) {
    Set<Cell> rawCells = ColumnValues.toCells(cells);
    Map<Cell, byte[]> rawResults = t.get(tableRef, rawCells);
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> rowMap =
        HashMultimap.create();
    for (Entry<Cell, byte[]> e : rawResults.entrySet()) {
      if (e.getValue().length > 0) {
        StreamTestWithHashStreamIdxRow row =
            StreamTestWithHashStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
        StreamTestWithHashStreamIdxColumn col =
            StreamTestWithHashStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(
  ...
  @Override
  public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> getAsync(
      final Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumn> cells,
      ExecutorService exec) {
    Callable<Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>> c =
        new Callable<
            Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>>() {
          @Override
          public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
              call() {
            return get(cells);
          }
        };
  ...
  @Override
  public List<StreamTestWithHashStreamIdxColumnValue> getRowColumns(
      StreamTestWithHashStreamIdxRow row) {
  ...
  @Override
  public List<StreamTestWithHashStreamIdxColumnValue> getRowColumns(
      StreamTestWithHashStreamIdxRow row, ColumnSelection columns) {
    byte[] bytes = row.persistToBytes();
    RowResult<byte[]> rowResult = t.getRows(tableRef, ImmutableSet.of(bytes), columns).get(bytes);
    if (rowResult == null) {
      return ImmutableList.of();
    } else {
      List<StreamTestWithHashStreamIdxColumnValue> ret =
  ...
  @Override
  public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
      getRowsMultimap(Iterable<StreamTestWithHashStreamIdxRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
      getRowsMultimap(Iterable<StreamTestWithHashStreamIdxRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
      getAsyncRowsMultimap(Iterable<StreamTestWithHashStreamIdxRow> rows, ExecutorService exec) {
    return getAsyncRowsMultimap(rows, allColumns, exec);
  }

  @Override
  public Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
      getAsyncRowsMultimap(
          final Iterable<StreamTestWithHashStreamIdxRow> rows,
  ...
  private Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
      getRowsMultimapInternal(
          Iterable<StreamTestWithHashStreamIdxRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    return getRowMapFromRowResults(results.values());
  }

  private static Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>
      getRowMapFromRowResults(Collection<RowResult<byte[]>> rowResults) {
    Multimap<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue> rowMap =
        HashMultimap.create();
    for (RowResult<byte[]> result : rowResults) {
      StreamTestWithHashStreamIdxRow row =
          StreamTestWithHashStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  @Override
  public Map<
          StreamTestWithHashStreamIdxRow, BatchingVisitable<StreamTestWithHashStreamIdxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestWithHashStreamIdxRow> rows,
    ...
    Map<StreamTestWithHashStreamIdxRow, BatchingVisitable<StreamTestWithHashStreamIdxColumnValue>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestWithHashStreamIdxRow row =
          StreamTestWithHashStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestWithHashStreamIdxColumnValue> bv =
  ...
  @Override
  public Iterator<Map.Entry<StreamTestWithHashStreamIdxRow, StreamTestWithHashStreamIdxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestWithHashStreamIdxRow> rows,
    ...
    return Iterators.transform(
        ...
        e -> {
          StreamTestWithHashStreamIdxRow row =
              StreamTestWithHashStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getRowName());
          StreamTestWithHashStreamIdxColumn col =
              StreamTestWithHashStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getColumnName());
          Long val = StreamTestWithHashStreamIdxColumnValue.hydrateValue(e.getValue());
          StreamTestWithHashStreamIdxColumnValue colValue =
              StreamTestWithHashStreamIdxColumnValue.of(col, val);
  ...
  static String __CLASS_HASH = "a/241JdysXRuYKeuq83EFA==";
}
