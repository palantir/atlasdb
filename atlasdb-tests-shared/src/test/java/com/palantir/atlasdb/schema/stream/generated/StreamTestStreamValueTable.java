...
public final class StreamTestStreamValueTable
  ...
  private static final String rawTableName = "stream_test_stream_value";
  private final TableReference tableRef;
  private static final ColumnSelection allColumns =
      getColumnSelection(StreamTestStreamValueNamedColumn.values());

  static StreamTestStreamValueTable of(Transaction t, Namespace namespace) {
    return new StreamTestStreamValueTable(
        t, namespace, ImmutableList.<StreamTestStreamValueTrigger>of());
  }

  static StreamTestStreamValueTable of(
      Transaction t,
      Namespace namespace,
      StreamTestStreamValueTrigger trigger,
      StreamTestStreamValueTrigger... triggers) {
    return new StreamTestStreamValueTable(
        t,
        namespace,
        ImmutableList.<StreamTestStreamValueTrigger>builder().add(trigger).add(triggers).build());
  }

  static StreamTestStreamValueTable of(
      Transaction t, Namespace namespace, List<StreamTestStreamValueTrigger> triggers) {
    return new StreamTestStreamValueTable(t, namespace, triggers);
  }

  private StreamTestStreamValueTable(
      Transaction t, Namespace namespace, List<StreamTestStreamValueTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestStreamValueRow
      implements Persistable, Comparable<StreamTestStreamValueRow> {
    ...
    public static final Hydrator<StreamTestStreamValueRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestStreamValueRow>() {
          @Override
  ...
  public interface StreamTestStreamValueTrigger {
    public void putStreamTestStreamValue(
        Multimap<StreamTestStreamValueRow, ? extends StreamTestStreamValueNamedColumnValue<?>>
            newRows);
  }
  ...
  public static final class StreamTestStreamValueRowResult implements TypedRowResult {
    ...
    public static Function<StreamTestStreamValueRowResult, StreamTestStreamValueRow>
        getRowNameFun() {
    ...
    public static Function<RowResult<byte[]>, StreamTestStreamValueRowResult>
        fromRawRowResultFun() {
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestStreamValueNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, StreamTestStreamValueNamedColumn.toShortName()));
  }
  ...
  private static final Map<String, Hydrator<? extends StreamTestStreamValueNamedColumnValue<?>>>
      shortNameToHydrator =
          ImmutableMap
              .<String, Hydrator<? extends StreamTestStreamValueNamedColumnValue<?>>>builder()
              .put("v", Value.BYTES_HYDRATOR)
              .build();

  public Map<StreamTestStreamValueRow, byte[]> getValues(
      Collection<StreamTestStreamValueRow> rows) {
  ...
  public void putValue(Map<StreamTestStreamValueRow, byte[]> map) {
    Map<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>> toPut =
  ...
  @Override
  public void put(
      Multimap<StreamTestStreamValueRow, ? extends StreamTestStreamValueNamedColumnValue<?>> rows) {
  ...
  public void putUnlessExists(
      Multimap<StreamTestStreamValueRow, ? extends StreamTestStreamValueNamedColumnValue<?>> rows) {
    Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>> existing =
        getRowsMultimap(rows.keySet());
    Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>> toPut =
        HashMultimap.create();
    for (Entry<StreamTestStreamValueRow, ? extends StreamTestStreamValueNamedColumnValue<?>> entry :
        rows.entries()) {
  ...
  @Override
  public Optional<StreamTestStreamValueRowResult> getRow(
      StreamTestStreamValueRow row, ColumnSelection columns) {
  ...
  @Override
  public List<StreamTestStreamValueRowResult> getRows(
      Iterable<StreamTestStreamValueRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    List<StreamTestStreamValueRowResult> rowResults =
  ...
  @Override
  public List<StreamTestStreamValueRowResult> getAsyncRows(
      Iterable<StreamTestStreamValueRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<StreamTestStreamValueRowResult> getAsyncRows(
      final Iterable<StreamTestStreamValueRow> rows,
  ...
  @Override
  public List<StreamTestStreamValueNamedColumnValue<?>> getRowColumns(
      StreamTestStreamValueRow row) {
  ...
  public List<StreamTestStreamValueNamedColumnValue<?>> getRowColumns(
    ...
    if (rowResult == null) {
      ...
      List<StreamTestStreamValueNamedColumnValue<?>> ret =
  ...
  @Override
  public Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestStreamValueRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestStreamValueRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
      getAsyncRowsMultimap(Iterable<StreamTestStreamValueRow> rows, ExecutorService exec) {
  ...
  public Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
    ...
    Callable<Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>> c =
        new Callable<
            Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>>() {
          @Override
          public Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
              call() {
            return getRowsMultimapInternal(rows, columns);
  ...
  private Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
      getRowsMultimapInternal(Iterable<StreamTestStreamValueRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    return getRowMapFromRowResults(results.values());
  }

  private static Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>
      getRowMapFromRowResults(Collection<RowResult<byte[]>> rowResults) {
    Multimap<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>> rowMap =
        HashMultimap.create();
    for (RowResult<byte[]> result : rowResults) {
      StreamTestStreamValueRow row =
          StreamTestStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  @Override
  public Map<StreamTestStreamValueRow, BatchingVisitable<StreamTestStreamValueNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<StreamTestStreamValueRow> rows, BatchColumnRangeSelection columnRangeSelection) {
    ...
    Map<StreamTestStreamValueRow, BatchingVisitable<StreamTestStreamValueNamedColumnValue<?>>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestStreamValueRow row =
          StreamTestStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestStreamValueNamedColumnValue<?>> bv =
  ...
  @Override
  public Iterator<Map.Entry<StreamTestStreamValueRow, StreamTestStreamValueNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<StreamTestStreamValueRow> rows,
    ...
    return Iterators.transform(
        ...
        e -> {
          StreamTestStreamValueRow row =
              StreamTestStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
          StreamTestStreamValueNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "UtljFx6mLNzcWB/w+HhJWw==";
}
