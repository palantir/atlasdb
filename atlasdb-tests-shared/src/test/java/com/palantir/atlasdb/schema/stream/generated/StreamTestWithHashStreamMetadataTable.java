...
public final class StreamTestWithHashStreamMetadataTable
  ...
  private static final String rawTableName = "stream_test_with_hash_stream_metadata";
  private final TableReference tableRef;
  private static final ColumnSelection allColumns =
      getColumnSelection(StreamTestWithHashStreamMetadataNamedColumn.values());

  static StreamTestWithHashStreamMetadataTable of(Transaction t, Namespace namespace) {
    return new StreamTestWithHashStreamMetadataTable(
        t, namespace, ImmutableList.<StreamTestWithHashStreamMetadataTrigger>of());
  }

  static StreamTestWithHashStreamMetadataTable of(
      Transaction t,
      Namespace namespace,
      StreamTestWithHashStreamMetadataTrigger trigger,
      StreamTestWithHashStreamMetadataTrigger... triggers) {
    return new StreamTestWithHashStreamMetadataTable(
        t,
        namespace,
        ImmutableList.<StreamTestWithHashStreamMetadataTrigger>builder()
            .add(trigger)
            .add(triggers)
            .build());
  }
  ...
  static StreamTestWithHashStreamMetadataTable of(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamMetadataTrigger> triggers) {
    return new StreamTestWithHashStreamMetadataTable(t, namespace, triggers);
  }

  private StreamTestWithHashStreamMetadataTable(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamMetadataTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamMetadataRow
      implements Persistable, Comparable<StreamTestWithHashStreamMetadataRow> {
    ...
    public static final Hydrator<StreamTestWithHashStreamMetadataRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestWithHashStreamMetadataRow>() {
          @Override
  ...
  public static final class Metadata
      implements StreamTestWithHashStreamMetadataNamedColumnValue<
  ...
  public interface StreamTestWithHashStreamMetadataTrigger {
    public void putStreamTestWithHashStreamMetadata(
        Multimap<
                StreamTestWithHashStreamMetadataRow,
                ? extends StreamTestWithHashStreamMetadataNamedColumnValue<?>>
            newRows);
  }
  ...
  public static final class StreamTestWithHashStreamMetadataRowResult implements TypedRowResult {
    ...
    public static Function<
            StreamTestWithHashStreamMetadataRowResult, StreamTestWithHashStreamMetadataRow>
        getRowNameFun() {
      return new Function<
          StreamTestWithHashStreamMetadataRowResult, StreamTestWithHashStreamMetadataRow>() {
        @Override
        public StreamTestWithHashStreamMetadataRow apply(
            StreamTestWithHashStreamMetadataRowResult rowResult) {
          return rowResult.getRowName();
        }
      };
    }

    public static Function<RowResult<byte[]>, StreamTestWithHashStreamMetadataRowResult>
        fromRawRowResultFun() {
    ...
    public static Function<
            StreamTestWithHashStreamMetadataRowResult,
            com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
        getMetadataFun() {
      return new Function<
          StreamTestWithHashStreamMetadataRowResult,
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestWithHashStreamMetadataNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, StreamTestWithHashStreamMetadataNamedColumn.toShortName()));
  }

  public static ColumnSelection getColumnSelection(
      StreamTestWithHashStreamMetadataNamedColumn... cols) {
    return getColumnSelection(Arrays.asList(cols));
  }

  private static final Map<
          String, Hydrator<? extends StreamTestWithHashStreamMetadataNamedColumnValue<?>>>
      shortNameToHydrator =
          ImmutableMap
              .<String, Hydrator<? extends StreamTestWithHashStreamMetadataNamedColumnValue<?>>>
                  builder()
  ...
  public Map<
          StreamTestWithHashStreamMetadataRow,
          com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
      getMetadatas(Collection<StreamTestWithHashStreamMetadataRow> rows) {
    Map<Cell, StreamTestWithHashStreamMetadataRow> cells =
  ...
  public void putMetadata(
      StreamTestWithHashStreamMetadataRow row,
      com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata value) {
  ...
  public void putMetadata(
      Map<
              ...
              com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
          map) {
    Map<StreamTestWithHashStreamMetadataRow, StreamTestWithHashStreamMetadataNamedColumnValue<?>>
        toPut = Maps.newHashMapWithExpectedSize(map.size());
    for (Entry<
            StreamTestWithHashStreamMetadataRow,
            com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
        e : map.entrySet()) {
  ...
  @Override
  public Optional<StreamTestWithHashStreamMetadataRowResult> getRow(
      StreamTestWithHashStreamMetadataRow row) {
  ...
  @Override
  public Optional<StreamTestWithHashStreamMetadataRowResult> getRow(
      StreamTestWithHashStreamMetadataRow row, ColumnSelection columns) {
  ...
  @Override
  public List<StreamTestWithHashStreamMetadataRowResult> getRows(
      Iterable<StreamTestWithHashStreamMetadataRow> rows) {
    return getRows(rows, allColumns);
  }

  @Override
  public List<StreamTestWithHashStreamMetadataRowResult> getRows(
      Iterable<StreamTestWithHashStreamMetadataRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    List<StreamTestWithHashStreamMetadataRowResult> rowResults =
  ...
  @Override
  public List<StreamTestWithHashStreamMetadataRowResult> getAsyncRows(
      Iterable<StreamTestWithHashStreamMetadataRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<StreamTestWithHashStreamMetadataRowResult> getAsyncRows(
      final Iterable<StreamTestWithHashStreamMetadataRow> rows,
  ...
  @Override
  public List<StreamTestWithHashStreamMetadataNamedColumnValue<?>> getRowColumns(
      StreamTestWithHashStreamMetadataRow row) {
  ...
  public List<StreamTestWithHashStreamMetadataNamedColumnValue<?>> getRowColumns(
    ...
    if (rowResult == null) {
      ...
      List<StreamTestWithHashStreamMetadataNamedColumnValue<?>> ret =
  ...
  @Override
  public Multimap<
          StreamTestWithHashStreamMetadataRow, StreamTestWithHashStreamMetadataNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestWithHashStreamMetadataRow> rows) {
  ...
  public Multimap<
          StreamTestWithHashStreamMetadataRow, StreamTestWithHashStreamMetadataNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestWithHashStreamMetadataRow> rows, ColumnSelection columns) {
  ...
  private static Multimap<
    ...
    for (RowResult<byte[]> result : rowResults) {
      StreamTestWithHashStreamMetadataRow row =
          StreamTestWithHashStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  public Map<
          StreamTestWithHashStreamMetadataRow,
          BatchingVisitable<StreamTestWithHashStreamMetadataNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<StreamTestWithHashStreamMetadataRow> rows,
    ...
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestWithHashStreamMetadataRow row =
          StreamTestWithHashStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestWithHashStreamMetadataNamedColumnValue<?>> bv =
  ...
  public Iterator<
    ...
    return Iterators.transform(
        ...
        e -> {
          StreamTestWithHashStreamMetadataRow row =
              StreamTestWithHashStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getRowName());
          StreamTestWithHashStreamMetadataNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "vDZu5t5jtSQ69rvbWnkYUw==";
}
