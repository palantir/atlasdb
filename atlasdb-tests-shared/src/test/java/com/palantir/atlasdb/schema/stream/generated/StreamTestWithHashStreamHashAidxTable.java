...
public final class StreamTestWithHashStreamHashAidxTable
  ...
  private static final String rawTableName = "stream_test_with_hash_stream_hash_aidx";
  ...
  static StreamTestWithHashStreamHashAidxTable of(Transaction t, Namespace namespace) {
    return new StreamTestWithHashStreamHashAidxTable(
        t, namespace, ImmutableList.<StreamTestWithHashStreamHashAidxTrigger>of());
  }

  static StreamTestWithHashStreamHashAidxTable of(
      Transaction t,
      Namespace namespace,
      StreamTestWithHashStreamHashAidxTrigger trigger,
      StreamTestWithHashStreamHashAidxTrigger... triggers) {
    return new StreamTestWithHashStreamHashAidxTable(
        t,
        namespace,
        ImmutableList.<StreamTestWithHashStreamHashAidxTrigger>builder()
            .add(trigger)
            .add(triggers)
            .build());
  }
  ...
  static StreamTestWithHashStreamHashAidxTable of(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamHashAidxTrigger> triggers) {
    return new StreamTestWithHashStreamHashAidxTable(t, namespace, triggers);
  }

  private StreamTestWithHashStreamHashAidxTable(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamHashAidxTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamHashAidxRow
      implements Persistable, Comparable<StreamTestWithHashStreamHashAidxRow> {
    ...
    public static final Hydrator<StreamTestWithHashStreamHashAidxRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestWithHashStreamHashAidxRow>() {
          @Override
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamHashAidxColumn
      implements Persistable, Comparable<StreamTestWithHashStreamHashAidxColumn> {
    ...
    public static final Hydrator<StreamTestWithHashStreamHashAidxColumn> BYTES_HYDRATOR =
        new Hydrator<StreamTestWithHashStreamHashAidxColumn>() {
          @Override
  ...
  public interface StreamTestWithHashStreamHashAidxTrigger {
    public void putStreamTestWithHashStreamHashAidx(
        Multimap<
                StreamTestWithHashStreamHashAidxRow,
                ? extends StreamTestWithHashStreamHashAidxColumnValue>
            newRows);
  }
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamHashAidxColumnValue
      implements ColumnValue<Long> {
    private final StreamTestWithHashStreamHashAidxColumn columnName;
    private final Long value;

    public static StreamTestWithHashStreamHashAidxColumnValue of(
        StreamTestWithHashStreamHashAidxColumn columnName, Long value) {
      return new StreamTestWithHashStreamHashAidxColumnValue(columnName, value);
    }

    private StreamTestWithHashStreamHashAidxColumnValue(
        StreamTestWithHashStreamHashAidxColumn columnName, Long value) {
    ...
    public static Function<
            StreamTestWithHashStreamHashAidxColumnValue, StreamTestWithHashStreamHashAidxColumn>
        getColumnNameFun() {
      return new Function<
          StreamTestWithHashStreamHashAidxColumnValue, StreamTestWithHashStreamHashAidxColumn>() {
        @Override
        public StreamTestWithHashStreamHashAidxColumn apply(
            StreamTestWithHashStreamHashAidxColumnValue columnValue) {
  ...
  public static final class StreamTestWithHashStreamHashAidxRowResult implements TypedRowResult {
    ...
    public static StreamTestWithHashStreamHashAidxRowResult of(RowResult<byte[]> rowResult) {
      StreamTestWithHashStreamHashAidxRow rowName =
          StreamTestWithHashStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(
              rowResult.getRowName());
      Set<StreamTestWithHashStreamHashAidxColumnValue> columnValues =
          Sets.newHashSetWithExpectedSize(rowResult.getColumns().size());
      for (Entry<byte[], byte[]> e : rowResult.getColumns().entrySet()) {
        StreamTestWithHashStreamHashAidxColumn col =
            StreamTestWithHashStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      ...
      return new StreamTestWithHashStreamHashAidxRowResult(
          rowName, ImmutableSet.copyOf(columnValues));
    }

    private StreamTestWithHashStreamHashAidxRowResult(
        StreamTestWithHashStreamHashAidxRow rowName,
        ImmutableSet<StreamTestWithHashStreamHashAidxColumnValue> columnValues) {
    ...
    public static Function<
            StreamTestWithHashStreamHashAidxRowResult, StreamTestWithHashStreamHashAidxRow>
        getRowNameFun() {
      return new Function<
          StreamTestWithHashStreamHashAidxRowResult, StreamTestWithHashStreamHashAidxRow>() {
        @Override
        public StreamTestWithHashStreamHashAidxRow apply(
            StreamTestWithHashStreamHashAidxRowResult rowResult) {
    ...
    public static Function<
            StreamTestWithHashStreamHashAidxRowResult,
            ImmutableSet<StreamTestWithHashStreamHashAidxColumnValue>>
        getColumnValuesFun() {
      return new Function<
          StreamTestWithHashStreamHashAidxRowResult,
          ImmutableSet<StreamTestWithHashStreamHashAidxColumnValue>>() {
        @Override
        public ImmutableSet<StreamTestWithHashStreamHashAidxColumnValue> apply(
            StreamTestWithHashStreamHashAidxRowResult rowResult) {
  ...
  @Override
  public void delete(
      StreamTestWithHashStreamHashAidxRow row, StreamTestWithHashStreamHashAidxColumn column) {
    delete(ImmutableMultimap.of(row, column));
  }

  @Override
  public void delete(Iterable<StreamTestWithHashStreamHashAidxRow> rows) {
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn> toRemove =
        HashMultimap.create();
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
        result = getRowsMultimap(rows);
    for (Entry<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue> e :
        result.entries()) {
  ...
  @Override
  public void delete(
      Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn>
          values) {
  ...
  public void put(
      StreamTestWithHashStreamHashAidxRow rowName,
      Iterable<StreamTestWithHashStreamHashAidxColumnValue> values) {
    put(
        ImmutableMultimap
            .<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
                builder()
  ...
  public void put(
      StreamTestWithHashStreamHashAidxRow rowName,
      StreamTestWithHashStreamHashAidxColumnValue... values) {
    put(
        ImmutableMultimap
            .<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
                builder()
  ...
  public void putUnlessExists(
      Multimap<
              ...
              ? extends StreamTestWithHashStreamHashAidxColumnValue>
          rows) {
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn> toGet =
        Multimaps.transformValues(
            rows, StreamTestWithHashStreamHashAidxColumnValue.getColumnNameFun());
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
        existing = get(toGet);
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
        toPut = HashMultimap.create();
    for (Entry<
            StreamTestWithHashStreamHashAidxRow,
            ? extends StreamTestWithHashStreamHashAidxColumnValue>
        entry : rows.entries()) {
  ...
  public void touch(
      Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn>
          values) {
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
        currentValues = get(values);
    put(currentValues);
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn> toDelete =
        HashMultimap.create(values);
    for (Map.Entry<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
        e : currentValues.entries()) {
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestWithHashStreamHashAidxColumn> cols) {
  ...
  @Override
  public Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      get(
          Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn>
              cells) {
    ...
    Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
        rowMap = HashMultimap.create();
    for (Entry<Cell, byte[]> e : rawResults.entrySet()) {
      if (e.getValue().length > 0) {
        StreamTestWithHashStreamHashAidxRow row =
            StreamTestWithHashStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(
                e.getKey().getRowName());
        StreamTestWithHashStreamHashAidxColumn col =
            StreamTestWithHashStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(
  ...
  public Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      getAsync(
          final Multimap<
                  StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumn>
              cells,
  ...
  @Override
  public List<StreamTestWithHashStreamHashAidxColumnValue> getRowColumns(
      StreamTestWithHashStreamHashAidxRow row) {
  ...
  @Override
  public List<StreamTestWithHashStreamHashAidxColumnValue> getRowColumns(
      StreamTestWithHashStreamHashAidxRow row, ColumnSelection columns) {
    byte[] bytes = row.persistToBytes();
    RowResult<byte[]> rowResult = t.getRows(tableRef, ImmutableSet.of(bytes), columns).get(bytes);
    if (rowResult == null) {
      return ImmutableList.of();
    } else {
      List<StreamTestWithHashStreamHashAidxColumnValue> ret =
  ...
  @Override
  public Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      getRowsMultimap(Iterable<StreamTestWithHashStreamHashAidxRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      getRowsMultimap(Iterable<StreamTestWithHashStreamHashAidxRow> rows, ColumnSelection columns) {
  ...
  public Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      getAsyncRowsMultimap(
          Iterable<StreamTestWithHashStreamHashAidxRow> rows, ExecutorService exec) {
  ...
  public Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      getAsyncRowsMultimap(
          final Iterable<StreamTestWithHashStreamHashAidxRow> rows,
  ...
  private Multimap<StreamTestWithHashStreamHashAidxRow, StreamTestWithHashStreamHashAidxColumnValue>
      getRowsMultimapInternal(
          Iterable<StreamTestWithHashStreamHashAidxRow> rows, ColumnSelection columns) {
  ...
  private static Multimap<
    ...
    for (RowResult<byte[]> result : rowResults) {
      StreamTestWithHashStreamHashAidxRow row =
          StreamTestWithHashStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  public Map<
          StreamTestWithHashStreamHashAidxRow,
          BatchingVisitable<StreamTestWithHashStreamHashAidxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestWithHashStreamHashAidxRow> rows,
    ...
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestWithHashStreamHashAidxRow row =
          StreamTestWithHashStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestWithHashStreamHashAidxColumnValue> bv =
          BatchingVisitables.transform(
              ...
              result -> {
                ...
                Long val =
                    StreamTestWithHashStreamHashAidxColumnValue.hydrateValue(result.getValue());
        ...
        e -> {
          ...
          StreamTestWithHashStreamHashAidxColumn col =
              StreamTestWithHashStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getColumnName());
          Long val = StreamTestWithHashStreamHashAidxColumnValue.hydrateValue(e.getValue());
          StreamTestWithHashStreamHashAidxColumnValue colValue =
              StreamTestWithHashStreamHashAidxColumnValue.of(col, val);
  ...
  static String __CLASS_HASH = "S3Q3ccm4aiEC8HFPDcowow==";
}
