...
public final class StreamTestStreamIdxTable
  ...
  private static final String rawTableName = "stream_test_stream_idx";
  ...
  static StreamTestStreamIdxTable of(Transaction t, Namespace namespace) {
    return new StreamTestStreamIdxTable(
        t, namespace, ImmutableList.<StreamTestStreamIdxTrigger>of());
  }

  static StreamTestStreamIdxTable of(
      Transaction t,
      Namespace namespace,
      StreamTestStreamIdxTrigger trigger,
      StreamTestStreamIdxTrigger... triggers) {
    return new StreamTestStreamIdxTable(
        t,
        namespace,
        ImmutableList.<StreamTestStreamIdxTrigger>builder().add(trigger).add(triggers).build());
  }

  static StreamTestStreamIdxTable of(
      Transaction t, Namespace namespace, List<StreamTestStreamIdxTrigger> triggers) {
    return new StreamTestStreamIdxTable(t, namespace, triggers);
  }

  private StreamTestStreamIdxTable(
      Transaction t, Namespace namespace, List<StreamTestStreamIdxTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestStreamIdxRow
      implements Persistable, Comparable<StreamTestStreamIdxRow> {
    ...
    public static final Hydrator<StreamTestStreamIdxRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestStreamIdxRow>() {
          @Override
   ...
   * </pre>
   */
  public static final class StreamTestStreamIdxColumn
      implements Persistable, Comparable<StreamTestStreamIdxColumn> {
    ...
    public static final Hydrator<StreamTestStreamIdxColumn> BYTES_HYDRATOR =
        new Hydrator<StreamTestStreamIdxColumn>() {
          @Override
  ...
  public interface StreamTestStreamIdxTrigger {
    public void putStreamTestStreamIdx(
        Multimap<StreamTestStreamIdxRow, ? extends StreamTestStreamIdxColumnValue> newRows);
  }
  ...
  public static final class StreamTestStreamIdxColumnValue implements ColumnValue<Long> {
    ...
    public static StreamTestStreamIdxColumnValue of(
        StreamTestStreamIdxColumn columnName, Long value) {
    ...
    public static Function<StreamTestStreamIdxColumnValue, StreamTestStreamIdxColumn>
        getColumnNameFun() {
  ...
  public static final class StreamTestStreamIdxRowResult implements TypedRowResult {
    ...
    public static StreamTestStreamIdxRowResult of(RowResult<byte[]> rowResult) {
      StreamTestStreamIdxRow rowName =
          StreamTestStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(rowResult.getRowName());
      Set<StreamTestStreamIdxColumnValue> columnValues =
          Sets.newHashSetWithExpectedSize(rowResult.getColumns().size());
      for (Entry<byte[], byte[]> e : rowResult.getColumns().entrySet()) {
        StreamTestStreamIdxColumn col =
            StreamTestStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
    ...
    private StreamTestStreamIdxRowResult(
        StreamTestStreamIdxRow rowName, ImmutableSet<StreamTestStreamIdxColumnValue> columnValues) {
    ...
    public static Function<
            StreamTestStreamIdxRowResult, ImmutableSet<StreamTestStreamIdxColumnValue>>
        getColumnValuesFun() {
      return new Function<
          StreamTestStreamIdxRowResult, ImmutableSet<StreamTestStreamIdxColumnValue>>() {
        @Override
        public ImmutableSet<StreamTestStreamIdxColumnValue> apply(
            StreamTestStreamIdxRowResult rowResult) {
  ...
  public void put(StreamTestStreamIdxRow rowName, Iterable<StreamTestStreamIdxColumnValue> values) {
    put(
        ImmutableMultimap.<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue>builder()
  ...
  @Override
  public void put(
      Multimap<StreamTestStreamIdxRow, ? extends StreamTestStreamIdxColumnValue> values) {
  ...
  public void putUnlessExists(
      StreamTestStreamIdxRow rowName, Iterable<StreamTestStreamIdxColumnValue> values) {
    putUnlessExists(
        ImmutableMultimap.<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue>builder()
            .putAll(rowName, values)
            .build());
  ...
  @Override
  public void putUnlessExists(
      StreamTestStreamIdxRow rowName, StreamTestStreamIdxColumnValue... values) {
    putUnlessExists(
        ImmutableMultimap.<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue>builder()
            .putAll(rowName, values)
            .build());
  ...
  @Override
  public void putUnlessExists(
      Multimap<StreamTestStreamIdxRow, ? extends StreamTestStreamIdxColumnValue> rows) {
    Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumn> toGet =
        Multimaps.transformValues(rows, StreamTestStreamIdxColumnValue.getColumnNameFun());
    ...
    for (Entry<StreamTestStreamIdxRow, ? extends StreamTestStreamIdxColumnValue> entry :
        rows.entries()) {
  ...
  public void touch(Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumn> values) {
    ...
    put(currentValues);
    Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumn> toDelete =
        HashMultimap.create(values);
    for (Map.Entry<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> e :
  ...
  @Override
  public Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> get(
      Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumn> cells) {
    Set<Cell> rawCells = ColumnValues.toCells(cells);
    Map<Cell, byte[]> rawResults = t.get(tableRef, rawCells);
    Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> rowMap = HashMultimap.create();
    for (Entry<Cell, byte[]> e : rawResults.entrySet()) {
      if (e.getValue().length > 0) {
        StreamTestStreamIdxRow row =
            StreamTestStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
        StreamTestStreamIdxColumn col =
            StreamTestStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getColumnName());
  ...
  @Override
  public Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> getAsync(
      final Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumn> cells,
  ...
  @Override
  public List<StreamTestStreamIdxColumnValue> getRowColumns(
      StreamTestStreamIdxRow row, ColumnSelection columns) {
    byte[] bytes = row.persistToBytes();
    RowResult<byte[]> rowResult = t.getRows(tableRef, ImmutableSet.of(bytes), columns).get(bytes);
    if (rowResult == null) {
      return ImmutableList.of();
    } else {
      List<StreamTestStreamIdxColumnValue> ret =
  ...
  @Override
  public Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> getRowsMultimap(
      Iterable<StreamTestStreamIdxRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> getRowsMultimap(
      Iterable<StreamTestStreamIdxRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> getAsyncRowsMultimap(
      Iterable<StreamTestStreamIdxRow> rows, ExecutorService exec) {
    return getAsyncRowsMultimap(rows, allColumns, exec);
  }

  @Override
  public Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> getAsyncRowsMultimap(
      final Iterable<StreamTestStreamIdxRow> rows,
  ...
  private Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> getRowsMultimapInternal(
      Iterable<StreamTestStreamIdxRow> rows, ColumnSelection columns) {
  ...
  private static Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue>
      getRowMapFromRowResults(Collection<RowResult<byte[]>> rowResults) {
    Multimap<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue> rowMap = HashMultimap.create();
    for (RowResult<byte[]> result : rowResults) {
      StreamTestStreamIdxRow row =
          StreamTestStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  @Override
  public Map<StreamTestStreamIdxRow, BatchingVisitable<StreamTestStreamIdxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestStreamIdxRow> rows, BatchColumnRangeSelection columnRangeSelection) {
    ...
    Map<StreamTestStreamIdxRow, BatchingVisitable<StreamTestStreamIdxColumnValue>> transformed =
        Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestStreamIdxRow row =
          StreamTestStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestStreamIdxColumnValue> bv =
          BatchingVisitables.transform(
              e.getValue(),
              result -> {
                StreamTestStreamIdxColumn col =
                    StreamTestStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(
  ...
  @Override
  public Iterator<Map.Entry<StreamTestStreamIdxRow, StreamTestStreamIdxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestStreamIdxRow> rows,
  ...
  static String __CLASS_HASH = "Tood39wkUAQ6CJ9uj67NqA==";
}
