...
public final class StreamTestWithHashStreamValueTable
  ...
  private static final String rawTableName = "stream_test_with_hash_stream_value";
  private final TableReference tableRef;
  private static final ColumnSelection allColumns =
      getColumnSelection(StreamTestWithHashStreamValueNamedColumn.values());

  static StreamTestWithHashStreamValueTable of(Transaction t, Namespace namespace) {
    return new StreamTestWithHashStreamValueTable(
        t, namespace, ImmutableList.<StreamTestWithHashStreamValueTrigger>of());
  }

  static StreamTestWithHashStreamValueTable of(
      Transaction t,
      Namespace namespace,
      StreamTestWithHashStreamValueTrigger trigger,
      StreamTestWithHashStreamValueTrigger... triggers) {
    return new StreamTestWithHashStreamValueTable(
        t,
        namespace,
        ImmutableList.<StreamTestWithHashStreamValueTrigger>builder()
            .add(trigger)
            .add(triggers)
            .build());
  }
  ...
  static StreamTestWithHashStreamValueTable of(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamValueTrigger> triggers) {
    return new StreamTestWithHashStreamValueTable(t, namespace, triggers);
  }

  private StreamTestWithHashStreamValueTable(
      Transaction t, Namespace namespace, List<StreamTestWithHashStreamValueTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestWithHashStreamValueRow
      implements Persistable, Comparable<StreamTestWithHashStreamValueRow> {
    ...
    public static final Hydrator<StreamTestWithHashStreamValueRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestWithHashStreamValueRow>() {
          @Override
    ...
    public boolean equals(Object obj) {
      ...
      return Objects.equal(firstComponentHash, other.firstComponentHash)
          ...
          && Objects.equal(blockId, other.blockId);
    }
  ...
  public interface StreamTestWithHashStreamValueTrigger {
    public void putStreamTestWithHashStreamValue(
        Multimap<
                StreamTestWithHashStreamValueRow,
                ? extends StreamTestWithHashStreamValueNamedColumnValue<?>>
            newRows);
  }
  ...
  public static final class StreamTestWithHashStreamValueRowResult implements TypedRowResult {
    ...
    public static Function<StreamTestWithHashStreamValueRowResult, StreamTestWithHashStreamValueRow>
        getRowNameFun() {
      return new Function<
          StreamTestWithHashStreamValueRowResult, StreamTestWithHashStreamValueRow>() {
        @Override
        public StreamTestWithHashStreamValueRow apply(
            StreamTestWithHashStreamValueRowResult rowResult) {
          return rowResult.getRowName();
        }
      };
    }

    public static Function<RowResult<byte[]>, StreamTestWithHashStreamValueRowResult>
        fromRawRowResultFun() {
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestWithHashStreamValueNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, StreamTestWithHashStreamValueNamedColumn.toShortName()));
  }

  public static ColumnSelection getColumnSelection(
      StreamTestWithHashStreamValueNamedColumn... cols) {
    return getColumnSelection(Arrays.asList(cols));
  }

  private static final Map<
          String, Hydrator<? extends StreamTestWithHashStreamValueNamedColumnValue<?>>>
      shortNameToHydrator =
          ImmutableMap
              .<String, Hydrator<? extends StreamTestWithHashStreamValueNamedColumnValue<?>>>
                  builder()
  ...
  public Map<StreamTestWithHashStreamValueRow, byte[]> getValues(
      Collection<StreamTestWithHashStreamValueRow> rows) {
    Map<Cell, StreamTestWithHashStreamValueRow> cells =
    ...
    Map<StreamTestWithHashStreamValueRow, byte[]> ret =
  ...
  public void putValue(Map<StreamTestWithHashStreamValueRow, byte[]> map) {
    Map<StreamTestWithHashStreamValueRow, StreamTestWithHashStreamValueNamedColumnValue<?>> toPut =
  ...
  public void putUnlessExists(
      Multimap<
              ...
              ? extends StreamTestWithHashStreamValueNamedColumnValue<?>>
          rows) {
    Multimap<StreamTestWithHashStreamValueRow, StreamTestWithHashStreamValueNamedColumnValue<?>>
        existing = getRowsMultimap(rows.keySet());
    Multimap<StreamTestWithHashStreamValueRow, StreamTestWithHashStreamValueNamedColumnValue<?>>
  ...
  @Override
  public Optional<StreamTestWithHashStreamValueRowResult> getRow(
      StreamTestWithHashStreamValueRow row) {
    return getRow(row, allColumns);
  }

  @Override
  public Optional<StreamTestWithHashStreamValueRowResult> getRow(
      StreamTestWithHashStreamValueRow row, ColumnSelection columns) {
  ...
  @Override
  public List<StreamTestWithHashStreamValueRowResult> getRows(
      Iterable<StreamTestWithHashStreamValueRow> rows) {
    return getRows(rows, allColumns);
  }

  @Override
  public List<StreamTestWithHashStreamValueRowResult> getRows(
      Iterable<StreamTestWithHashStreamValueRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    List<StreamTestWithHashStreamValueRowResult> rowResults =
  ...
  @Override
  public List<StreamTestWithHashStreamValueRowResult> getAsyncRows(
      Iterable<StreamTestWithHashStreamValueRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<StreamTestWithHashStreamValueRowResult> getAsyncRows(
      final Iterable<StreamTestWithHashStreamValueRow> rows,
      final ColumnSelection columns,
      ExecutorService exec) {
    Callable<List<StreamTestWithHashStreamValueRowResult>> c =
        new Callable<List<StreamTestWithHashStreamValueRowResult>>() {
          @Override
          public List<StreamTestWithHashStreamValueRowResult> call() {
  ...
  @Override
  public List<StreamTestWithHashStreamValueNamedColumnValue<?>> getRowColumns(
      StreamTestWithHashStreamValueRow row) {
  ...
  public List<StreamTestWithHashStreamValueNamedColumnValue<?>> getRowColumns(
    ...
    if (rowResult == null) {
      ...
      List<StreamTestWithHashStreamValueNamedColumnValue<?>> ret =
  ...
  @Override
  public Multimap<
          StreamTestWithHashStreamValueRow, StreamTestWithHashStreamValueNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestWithHashStreamValueRow> rows) {
  ...
  public Multimap<
          StreamTestWithHashStreamValueRow, StreamTestWithHashStreamValueNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestWithHashStreamValueRow> rows, ColumnSelection columns) {
  ...
  public Multimap<
          StreamTestWithHashStreamValueRow, StreamTestWithHashStreamValueNamedColumnValue<?>>
      getAsyncRowsMultimap(Iterable<StreamTestWithHashStreamValueRow> rows, ExecutorService exec) {
  ...
  private static Multimap<
    ...
    for (RowResult<byte[]> result : rowResults) {
      StreamTestWithHashStreamValueRow row =
          StreamTestWithHashStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  public Map<
          StreamTestWithHashStreamValueRow,
          BatchingVisitable<StreamTestWithHashStreamValueNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<StreamTestWithHashStreamValueRow> rows,
    ...
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestWithHashStreamValueRow row =
          StreamTestWithHashStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestWithHashStreamValueNamedColumnValue<?>> bv =
  ...
  public Iterator<
    ...
    return Iterators.transform(
        ...
        e -> {
          StreamTestWithHashStreamValueRow row =
              StreamTestWithHashStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getRowName());
          StreamTestWithHashStreamValueNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "/FLfZ7TZ1odDxDMqAfJuRw==";
}
