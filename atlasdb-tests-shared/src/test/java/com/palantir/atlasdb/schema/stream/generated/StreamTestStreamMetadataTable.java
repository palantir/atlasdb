...
public final class StreamTestStreamMetadataTable implements
    ...
    @Override
    public Map<StreamTestStreamMetadataRow, BatchingVisitable<StreamTestStreamMetadataNamedColumnValue<?>>> getRowsColumnRange(Iterable<StreamTestStreamMetadataRow> rows, SizedColumnRangeSelection columnRangeSelection) {
    ...
    public Iterator<Map.Entry<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>> getRowsColumnRange(Iterable<StreamTestStreamMetadataRow> rows, ColumnRangeSelection columnRangeSelection, int batchHint) {
        ...
        return Iterators.transform(results, e -> {
            ...
            return new AbstractMap.SimpleEntry<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>(row, colValue);
        });
    }
     ...
     * {@link ValueType}
     */
    static String __CLASS_HASH = "GXCVualo4Okn+339E+z1Cw==";
}
