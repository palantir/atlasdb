...
public final class StreamTestStreamMetadataTable
  ...
  private static final String rawTableName = "stream_test_stream_metadata";
  private final TableReference tableRef;
  private static final ColumnSelection allColumns =
      getColumnSelection(StreamTestStreamMetadataNamedColumn.values());

  static StreamTestStreamMetadataTable of(Transaction t, Namespace namespace) {
    return new StreamTestStreamMetadataTable(
        t, namespace, ImmutableList.<StreamTestStreamMetadataTrigger>of());
  }

  static StreamTestStreamMetadataTable of(
      Transaction t,
      Namespace namespace,
      StreamTestStreamMetadataTrigger trigger,
      StreamTestStreamMetadataTrigger... triggers) {
    return new StreamTestStreamMetadataTable(
        t,
        namespace,
        ImmutableList.<StreamTestStreamMetadataTrigger>builder()
            .add(trigger)
            .add(triggers)
            .build());
  }
  ...
  static StreamTestStreamMetadataTable of(
      Transaction t, Namespace namespace, List<StreamTestStreamMetadataTrigger> triggers) {
    return new StreamTestStreamMetadataTable(t, namespace, triggers);
  }

  private StreamTestStreamMetadataTable(
      Transaction t, Namespace namespace, List<StreamTestStreamMetadataTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestStreamMetadataRow
      implements Persistable, Comparable<StreamTestStreamMetadataRow> {
    ...
    public static final Hydrator<StreamTestStreamMetadataRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestStreamMetadataRow>() {
          @Override
  ...
  public static final class Metadata
      implements StreamTestStreamMetadataNamedColumnValue<
    ...
    public static final Hydrator<Metadata> BYTES_HYDRATOR =
        new Hydrator<Metadata>() {
          ...
          public Metadata hydrateFromBytes(byte[] bytes) {
            ...
            try {
              return of(
                  com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata.parseFrom(
                      bytes));
  ...
  public interface StreamTestStreamMetadataTrigger {
    public void putStreamTestStreamMetadata(
        Multimap<StreamTestStreamMetadataRow, ? extends StreamTestStreamMetadataNamedColumnValue<?>>
            newRows);
  }
  ...
  public static final class StreamTestStreamMetadataRowResult implements TypedRowResult {
    ...
    public static Function<StreamTestStreamMetadataRowResult, StreamTestStreamMetadataRow>
        getRowNameFun() {
    ...
    public static Function<RowResult<byte[]>, StreamTestStreamMetadataRowResult>
        fromRawRowResultFun() {
    ...
    public static Function<
            StreamTestStreamMetadataRowResult,
            com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
        getMetadataFun() {
      return new Function<
          StreamTestStreamMetadataRowResult,
        ...
        public com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata apply(
            StreamTestStreamMetadataRowResult rowResult) {
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestStreamMetadataNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, StreamTestStreamMetadataNamedColumn.toShortName()));
  }
  ...
  private static final Map<String, Hydrator<? extends StreamTestStreamMetadataNamedColumnValue<?>>>
      shortNameToHydrator =
          ImmutableMap
              .<String, Hydrator<? extends StreamTestStreamMetadataNamedColumnValue<?>>>builder()
  ...
  public Map<
          StreamTestStreamMetadataRow,
          com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
      getMetadatas(Collection<StreamTestStreamMetadataRow> rows) {
  ...
  public void putMetadata(
      StreamTestStreamMetadataRow row,
      com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata value) {
  ...
  public void putMetadata(
      Map<
              ...
              com.palantir.atlasdb.protos.generated.StreamPersistence.StreamMetadata>
          map) {
    Map<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>> toPut =
  ...
  public void putUnlessExists(
      Multimap<StreamTestStreamMetadataRow, ? extends StreamTestStreamMetadataNamedColumnValue<?>>
          rows) {
    Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>> existing =
        getRowsMultimap(rows.keySet());
    Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>> toPut =
        HashMultimap.create();
    for (Entry<StreamTestStreamMetadataRow, ? extends StreamTestStreamMetadataNamedColumnValue<?>>
        entry : rows.entries()) {
  ...
  @Override
  public Optional<StreamTestStreamMetadataRowResult> getRow(
      StreamTestStreamMetadataRow row, ColumnSelection columns) {
  ...
  @Override
  public List<StreamTestStreamMetadataRowResult> getRows(
      Iterable<StreamTestStreamMetadataRow> rows) {
    return getRows(rows, allColumns);
  }

  @Override
  public List<StreamTestStreamMetadataRowResult> getRows(
      Iterable<StreamTestStreamMetadataRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    List<StreamTestStreamMetadataRowResult> rowResults =
        Lists.newArrayListWithCapacity(results.size());
  ...
  @Override
  public List<StreamTestStreamMetadataRowResult> getAsyncRows(
      Iterable<StreamTestStreamMetadataRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<StreamTestStreamMetadataRowResult> getAsyncRows(
      final Iterable<StreamTestStreamMetadataRow> rows,
  ...
  @Override
  public List<StreamTestStreamMetadataNamedColumnValue<?>> getRowColumns(
      StreamTestStreamMetadataRow row) {
  ...
  public List<StreamTestStreamMetadataNamedColumnValue<?>> getRowColumns(
    ...
    if (rowResult == null) {
      ...
      List<StreamTestStreamMetadataNamedColumnValue<?>> ret =
  ...
  @Override
  public Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestStreamMetadataRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
      getRowsMultimap(Iterable<StreamTestStreamMetadataRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
      getAsyncRowsMultimap(Iterable<StreamTestStreamMetadataRow> rows, ExecutorService exec) {
  ...
  public Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
    ...
    Callable<Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>> c =
        new Callable<
            Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>>() {
          @Override
          public Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
              call() {
            return getRowsMultimapInternal(rows, columns);
  ...
  private Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
      getRowsMultimapInternal(Iterable<StreamTestStreamMetadataRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    return getRowMapFromRowResults(results.values());
  }

  private static Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>
      getRowMapFromRowResults(Collection<RowResult<byte[]>> rowResults) {
    Multimap<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>> rowMap =
        HashMultimap.create();
    for (RowResult<byte[]> result : rowResults) {
      StreamTestStreamMetadataRow row =
          StreamTestStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  public Map<
          StreamTestStreamMetadataRow,
          BatchingVisitable<StreamTestStreamMetadataNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<StreamTestStreamMetadataRow> rows,
    ...
    Map<StreamTestStreamMetadataRow, BatchingVisitable<StreamTestStreamMetadataNamedColumnValue<?>>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestStreamMetadataRow row =
          StreamTestStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestStreamMetadataNamedColumnValue<?>> bv =
  ...
  @Override
  public Iterator<
          Map.Entry<StreamTestStreamMetadataRow, StreamTestStreamMetadataNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<StreamTestStreamMetadataRow> rows,
    ...
    return Iterators.transform(
        ...
        e -> {
          StreamTestStreamMetadataRow row =
              StreamTestStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
          StreamTestStreamMetadataNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "3LZcalnBELo6/h5AvFD5Rg==";
}
