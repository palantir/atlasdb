...
public final class StreamTestStreamHashAidxTable implements
    ...
    private final static String tableName = "default.stream_test_stream_hash_idx";

    static StreamTestStreamHashAidxTable of(Transaction t) {
        return new StreamTestStreamHashAidxTable(t, ImmutableList.<StreamTestStreamHashAidxTrigger>of());
    }

    static StreamTestStreamHashAidxTable of(Transaction t, StreamTestStreamHashAidxTrigger trigger, StreamTestStreamHashAidxTrigger... triggers) {
        return new StreamTestStreamHashAidxTable(t, ImmutableList.<StreamTestStreamHashAidxTrigger>builder().add(trigger).add(triggers).build());
    }

    static StreamTestStreamHashAidxTable of(Transaction t, List<StreamTestStreamHashAidxTrigger> triggers) {
        return new StreamTestStreamHashAidxTable(t, triggers);
    }

    private StreamTestStreamHashAidxTable(Transaction t, List<StreamTestStreamHashAidxTrigger> triggers) {
        this.t = t;
    ...
    @Override
    public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> getAsync(final Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> cells, ExecutorService exec) {
    ...
    @Override
    public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> getAsyncRowsMultimap(final Iterable<StreamTestStreamHashAidxRow> rows, final ColumnSelection columns, ExecutorService exec) {
        Callable<Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>> c =
                new Callable<Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>>() {
            @Override
            public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> call() {
     ...
     * {@link UnsignedBytes}
     */
    static String __CLASS_HASH = "d20CTwnKGEjPNFUjG5kctg==";
}
