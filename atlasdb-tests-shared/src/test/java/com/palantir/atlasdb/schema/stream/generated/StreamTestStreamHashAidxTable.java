...
public final class StreamTestStreamHashAidxTable
  ...
  private static final String rawTableName = "stream_test_stream_hash_aidx";
  ...
  static StreamTestStreamHashAidxTable of(Transaction t, Namespace namespace) {
    return new StreamTestStreamHashAidxTable(
        t, namespace, ImmutableList.<StreamTestStreamHashAidxTrigger>of());
  }

  static StreamTestStreamHashAidxTable of(
      Transaction t,
      Namespace namespace,
      StreamTestStreamHashAidxTrigger trigger,
      StreamTestStreamHashAidxTrigger... triggers) {
    return new StreamTestStreamHashAidxTable(
        t,
        namespace,
        ImmutableList.<StreamTestStreamHashAidxTrigger>builder()
            .add(trigger)
            .add(triggers)
            .build());
  }
  ...
  static StreamTestStreamHashAidxTable of(
      Transaction t, Namespace namespace, List<StreamTestStreamHashAidxTrigger> triggers) {
    return new StreamTestStreamHashAidxTable(t, namespace, triggers);
  }

  private StreamTestStreamHashAidxTable(
      Transaction t, Namespace namespace, List<StreamTestStreamHashAidxTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class StreamTestStreamHashAidxRow
      implements Persistable, Comparable<StreamTestStreamHashAidxRow> {
    ...
    public static final Hydrator<StreamTestStreamHashAidxRow> BYTES_HYDRATOR =
        new Hydrator<StreamTestStreamHashAidxRow>() {
          @Override
    ...
    public String toString() {
      return MoreObjects.toStringHelper(getClass().getSimpleName()).add("hash", hash).toString();
    }
   ...
   * </pre>
   */
  public static final class StreamTestStreamHashAidxColumn
      implements Persistable, Comparable<StreamTestStreamHashAidxColumn> {
    ...
    public static final Hydrator<StreamTestStreamHashAidxColumn> BYTES_HYDRATOR =
        new Hydrator<StreamTestStreamHashAidxColumn>() {
          @Override
  ...
  public interface StreamTestStreamHashAidxTrigger {
    public void putStreamTestStreamHashAidx(
        Multimap<StreamTestStreamHashAidxRow, ? extends StreamTestStreamHashAidxColumnValue>
            newRows);
  }
  ...
  public static final class StreamTestStreamHashAidxColumnValue implements ColumnValue<Long> {
    ...
    public static StreamTestStreamHashAidxColumnValue of(
        StreamTestStreamHashAidxColumn columnName, Long value) {
      return new StreamTestStreamHashAidxColumnValue(columnName, value);
    }

    private StreamTestStreamHashAidxColumnValue(
        StreamTestStreamHashAidxColumn columnName, Long value) {
    ...
    public static Function<StreamTestStreamHashAidxColumnValue, StreamTestStreamHashAidxColumn>
        getColumnNameFun() {
      return new Function<StreamTestStreamHashAidxColumnValue, StreamTestStreamHashAidxColumn>() {
        @Override
        public StreamTestStreamHashAidxColumn apply(
            StreamTestStreamHashAidxColumnValue columnValue) {
  ...
  public static final class StreamTestStreamHashAidxRowResult implements TypedRowResult {
    ...
    public static StreamTestStreamHashAidxRowResult of(RowResult<byte[]> rowResult) {
      StreamTestStreamHashAidxRow rowName =
          StreamTestStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(rowResult.getRowName());
      Set<StreamTestStreamHashAidxColumnValue> columnValues =
          Sets.newHashSetWithExpectedSize(rowResult.getColumns().size());
      for (Entry<byte[], byte[]> e : rowResult.getColumns().entrySet()) {
        StreamTestStreamHashAidxColumn col =
            StreamTestStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
    ...
    private StreamTestStreamHashAidxRowResult(
        StreamTestStreamHashAidxRow rowName,
        ImmutableSet<StreamTestStreamHashAidxColumnValue> columnValues) {
    ...
    public static Function<StreamTestStreamHashAidxRowResult, StreamTestStreamHashAidxRow>
        getRowNameFun() {
    ...
    public static Function<
            StreamTestStreamHashAidxRowResult, ImmutableSet<StreamTestStreamHashAidxColumnValue>>
        getColumnValuesFun() {
      return new Function<
          StreamTestStreamHashAidxRowResult, ImmutableSet<StreamTestStreamHashAidxColumnValue>>() {
        @Override
        public ImmutableSet<StreamTestStreamHashAidxColumnValue> apply(
            StreamTestStreamHashAidxRowResult rowResult) {
  ...
  public void delete(Iterable<StreamTestStreamHashAidxRow> rows) {
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> toRemove =
        HashMultimap.create();
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> result =
        getRowsMultimap(rows);
    for (Entry<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> e :
        result.entries()) {
  ...
  @Override
  public void put(
      StreamTestStreamHashAidxRow rowName, Iterable<StreamTestStreamHashAidxColumnValue> values) {
    put(
        ImmutableMultimap
            .<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>builder()
  ...
  @Override
  public void put(
      StreamTestStreamHashAidxRow rowName, StreamTestStreamHashAidxColumnValue... values) {
    put(
        ImmutableMultimap
            .<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>builder()
            .putAll(rowName, values)
  ...
  @Override
  public void put(
      Multimap<StreamTestStreamHashAidxRow, ? extends StreamTestStreamHashAidxColumnValue> values) {
  ...
  @Override
  public void putUnlessExists(
      Multimap<StreamTestStreamHashAidxRow, ? extends StreamTestStreamHashAidxColumnValue> rows) {
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> toGet =
        Multimaps.transformValues(rows, StreamTestStreamHashAidxColumnValue.getColumnNameFun());
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> existing =
        get(toGet);
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> toPut =
        HashMultimap.create();
    for (Entry<StreamTestStreamHashAidxRow, ? extends StreamTestStreamHashAidxColumnValue> entry :
        rows.entries()) {
  ...
  public void touch(Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> values) {
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> currentValues =
        get(values);
    put(currentValues);
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> toDelete =
        HashMultimap.create(values);
    for (Map.Entry<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> e :
  ...
  public static ColumnSelection getColumnSelection(
      Collection<StreamTestStreamHashAidxColumn> cols) {
  ...
  @Override
  public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> get(
      Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> cells) {
    Set<Cell> rawCells = ColumnValues.toCells(cells);
    Map<Cell, byte[]> rawResults = t.get(tableRef, rawCells);
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> rowMap =
        HashMultimap.create();
    for (Entry<Cell, byte[]> e : rawResults.entrySet()) {
      if (e.getValue().length > 0) {
        StreamTestStreamHashAidxRow row =
            StreamTestStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
        StreamTestStreamHashAidxColumn col =
            StreamTestStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(
  ...
  @Override
  public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> getAsync(
      final Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumn> cells,
      ExecutorService exec) {
    Callable<Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>> c =
        new Callable<Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>>() {
          @Override
          public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> call() {
            return get(cells);
          }
        };
  ...
  @Override
  public List<StreamTestStreamHashAidxColumnValue> getRowColumns(
      StreamTestStreamHashAidxRow row, ColumnSelection columns) {
    byte[] bytes = row.persistToBytes();
    RowResult<byte[]> rowResult = t.getRows(tableRef, ImmutableSet.of(bytes), columns).get(bytes);
    if (rowResult == null) {
      return ImmutableList.of();
    } else {
      List<StreamTestStreamHashAidxColumnValue> ret =
  ...
  @Override
  public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> getRowsMultimap(
      Iterable<StreamTestStreamHashAidxRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> getRowsMultimap(
      Iterable<StreamTestStreamHashAidxRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>
      getAsyncRowsMultimap(Iterable<StreamTestStreamHashAidxRow> rows, ExecutorService exec) {
  ...
  public Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>
      getAsyncRowsMultimap(
          final Iterable<StreamTestStreamHashAidxRow> rows,
  ...
  private Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>
      getRowsMultimapInternal(Iterable<StreamTestStreamHashAidxRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    return getRowMapFromRowResults(results.values());
  }

  private static Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>
      getRowMapFromRowResults(Collection<RowResult<byte[]>> rowResults) {
    Multimap<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue> rowMap =
        HashMultimap.create();
    for (RowResult<byte[]> result : rowResults) {
      StreamTestStreamHashAidxRow row =
          StreamTestStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  @Override
  public Map<StreamTestStreamHashAidxRow, BatchingVisitable<StreamTestStreamHashAidxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestStreamHashAidxRow> rows,
    ...
    Map<StreamTestStreamHashAidxRow, BatchingVisitable<StreamTestStreamHashAidxColumnValue>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      StreamTestStreamHashAidxRow row =
          StreamTestStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<StreamTestStreamHashAidxColumnValue> bv =
  ...
  @Override
  public Iterator<Map.Entry<StreamTestStreamHashAidxRow, StreamTestStreamHashAidxColumnValue>>
      getRowsColumnRange(
          Iterable<StreamTestStreamHashAidxRow> rows,
        ...
        e -> {
          ...
          StreamTestStreamHashAidxColumn col =
              StreamTestStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getColumnName());
          Long val = StreamTestStreamHashAidxColumnValue.hydrateValue(e.getValue());
          StreamTestStreamHashAidxColumnValue colValue =
              StreamTestStreamHashAidxColumnValue.of(col, val);
  ...
  static String __CLASS_HASH = "arK9bKh7KSdrf+q5KwLJuA==";
}
