...
public class SnapshotTransactionTest extends AtlasDbTestCase {
    ...
    public void testGetRowsLocalWritesWithColumnSelection() {
        ...
        RowResult<byte[]> rowResult1 = snapshotTx.getRows(TABLE, ImmutableList.of(row1Column1.getRowName()),
        ...
        RowResult<byte[]> rowResult2 = snapshotTx.getRows(TABLE, ImmutableList.of(row1Column1.getRowName()),
