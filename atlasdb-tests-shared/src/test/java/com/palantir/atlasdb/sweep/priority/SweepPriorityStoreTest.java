...
public class SweepPriorityStoreTest {
    ...
    public void testLoadEmpty() {
        assertThat(txManager.runTaskReadOnly(
                tx -> priorityStore.loadOldPriorities(tx, tx.getTimestamp())).isEmpty()).isTrue();
        assertThat(txManager.runTaskReadOnly(
                tx -> priorityStore.loadNewPriorities(tx)).isEmpty()).isTrue();
    }
