...
public final class UserPhotosStreamHashAidxTable
  ...
  static UserPhotosStreamHashAidxTable of(Transaction t, Namespace namespace) {
    return new UserPhotosStreamHashAidxTable(
        t, namespace, ImmutableList.<UserPhotosStreamHashAidxTrigger>of());
  }
  ...
  public interface UserPhotosStreamHashAidxTrigger {
    public void putUserPhotosStreamHashAidx(
        Multimap<UserPhotosStreamHashAidxRow, ? extends UserPhotosStreamHashAidxColumnValue>
            newRows);
  }
  ...
  public static final class UserPhotosStreamHashAidxColumnValue implements ColumnValue<Long> {
    ...
    public static UserPhotosStreamHashAidxColumnValue of(
        UserPhotosStreamHashAidxColumn columnName, Long value) {
      return new UserPhotosStreamHashAidxColumnValue(columnName, value);
    }

    private UserPhotosStreamHashAidxColumnValue(
        UserPhotosStreamHashAidxColumn columnName, Long value) {
    ...
    public static Function<UserPhotosStreamHashAidxColumnValue, UserPhotosStreamHashAidxColumn>
        getColumnNameFun() {
      return new Function<UserPhotosStreamHashAidxColumnValue, UserPhotosStreamHashAidxColumn>() {
        @Override
        public UserPhotosStreamHashAidxColumn apply(
            UserPhotosStreamHashAidxColumnValue columnValue) {
  ...
  public static final class UserPhotosStreamHashAidxRowResult implements TypedRowResult {
    ...
    private UserPhotosStreamHashAidxRowResult(
        UserPhotosStreamHashAidxRow rowName,
        ImmutableSet<UserPhotosStreamHashAidxColumnValue> columnValues) {
    ...
    public static Function<UserPhotosStreamHashAidxRowResult, UserPhotosStreamHashAidxRow>
        getRowNameFun() {
  ...
  public void delete(Iterable<UserPhotosStreamHashAidxRow> rows) {
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumn> toRemove =
        HashMultimap.create();
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> result =
        getRowsMultimap(rows);
    for (Entry<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> e :
        result.entries()) {
  ...
  @Override
  public void put(
      UserPhotosStreamHashAidxRow rowName, Iterable<UserPhotosStreamHashAidxColumnValue> values) {
    put(
        ImmutableMultimap
            .<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>builder()
  ...
  @Override
  public void put(
      UserPhotosStreamHashAidxRow rowName, UserPhotosStreamHashAidxColumnValue... values) {
    put(
        ImmutableMultimap
            .<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>builder()
            .putAll(rowName, values)
  ...
  @Override
  public void put(
      Multimap<UserPhotosStreamHashAidxRow, ? extends UserPhotosStreamHashAidxColumnValue> values) {
  ...
  @Override
  public void putUnlessExists(
      Multimap<UserPhotosStreamHashAidxRow, ? extends UserPhotosStreamHashAidxColumnValue> rows) {
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumn> toGet =
        Multimaps.transformValues(rows, UserPhotosStreamHashAidxColumnValue.getColumnNameFun());
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> existing =
        get(toGet);
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> toPut =
        HashMultimap.create();
    for (Entry<UserPhotosStreamHashAidxRow, ? extends UserPhotosStreamHashAidxColumnValue> entry :
        rows.entries()) {
  ...
  public void touch(Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumn> values) {
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> currentValues =
        get(values);
    put(currentValues);
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumn> toDelete =
        HashMultimap.create(values);
    for (Map.Entry<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> e :
  ...
  public static ColumnSelection getColumnSelection(
      Collection<UserPhotosStreamHashAidxColumn> cols) {
  ...
  public Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> get(
    ...
    Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> rowMap =
        HashMultimap.create();
    for (Entry<Cell, byte[]> e : rawResults.entrySet()) {
      if (e.getValue().length > 0) {
        UserPhotosStreamHashAidxRow row =
            UserPhotosStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
        UserPhotosStreamHashAidxColumn col =
  ...
  @Override
  public Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue> getAsync(
      final Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumn> cells,
  ...
  @Override
  public Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>
      getAsyncRowsMultimap(Iterable<UserPhotosStreamHashAidxRow> rows, ExecutorService exec) {
  ...
  public Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>
      getAsyncRowsMultimap(
          final Iterable<UserPhotosStreamHashAidxRow> rows,
  ...
  private Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>
      getRowsMultimapInternal(Iterable<UserPhotosStreamHashAidxRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    return getRowMapFromRowResults(results.values());
  }

  private static Multimap<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>
  ...
  @Override
  public Map<UserPhotosStreamHashAidxRow, BatchingVisitable<UserPhotosStreamHashAidxColumnValue>>
      getRowsColumnRange(
          Iterable<UserPhotosStreamHashAidxRow> rows,
    ...
    Map<UserPhotosStreamHashAidxRow, BatchingVisitable<UserPhotosStreamHashAidxColumnValue>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      UserPhotosStreamHashAidxRow row =
          UserPhotosStreamHashAidxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
  ...
  @Override
  public Iterator<Map.Entry<UserPhotosStreamHashAidxRow, UserPhotosStreamHashAidxColumnValue>>
      getRowsColumnRange(
          Iterable<UserPhotosStreamHashAidxRow> rows,
        ...
        e -> {
          ...
          UserPhotosStreamHashAidxColumn col =
              UserPhotosStreamHashAidxColumn.BYTES_HYDRATOR.hydrateFromBytes(
                  e.getKey().getColumnName());
          Long val = UserPhotosStreamHashAidxColumnValue.hydrateValue(e.getValue());
          UserPhotosStreamHashAidxColumnValue colValue =
              UserPhotosStreamHashAidxColumnValue.of(col, val);
  ...
  static String __CLASS_HASH = "DmZ+TtZYQoql6rivdmVNKQ==";
}
