...
public final class UserPhotosStreamIdxTable
  ...
  static UserPhotosStreamIdxTable of(Transaction t, Namespace namespace) {
    return new UserPhotosStreamIdxTable(
        t, namespace, ImmutableList.<UserPhotosStreamIdxTrigger>of());
  }
  ...
  static UserPhotosStreamIdxTable of(
    ...
    return new UserPhotosStreamIdxTable(
        t,
        namespace,
        ImmutableList.<UserPhotosStreamIdxTrigger>builder().add(trigger).add(triggers).build());
  }

  static UserPhotosStreamIdxTable of(
      Transaction t, Namespace namespace, List<UserPhotosStreamIdxTrigger> triggers) {
    return new UserPhotosStreamIdxTable(t, namespace, triggers);
  }

  private UserPhotosStreamIdxTable(
      Transaction t, Namespace namespace, List<UserPhotosStreamIdxTrigger> triggers) {
    this.t = t;
   ...
   * </pre>
   */
  public static final class UserPhotosStreamIdxRow
      implements Persistable, Comparable<UserPhotosStreamIdxRow> {
    ...
    public static final Hydrator<UserPhotosStreamIdxRow> BYTES_HYDRATOR =
        new Hydrator<UserPhotosStreamIdxRow>() {
          @Override
   ...
   * </pre>
   */
  public static final class UserPhotosStreamIdxColumn
      implements Persistable, Comparable<UserPhotosStreamIdxColumn> {
  ...
  public static final class UserPhotosStreamIdxColumnValue implements ColumnValue<Long> {
    ...
    public static UserPhotosStreamIdxColumnValue of(
        UserPhotosStreamIdxColumn columnName, Long value) {
    ...
    public static Function<UserPhotosStreamIdxColumnValue, UserPhotosStreamIdxColumn>
        getColumnNameFun() {
  ...
  public static final class UserPhotosStreamIdxRowResult implements TypedRowResult {
    ...
    public static UserPhotosStreamIdxRowResult of(RowResult<byte[]> rowResult) {
      ...
      for (Entry<byte[], byte[]> e : rowResult.getColumns().entrySet()) {
        UserPhotosStreamIdxColumn col =
            UserPhotosStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
    ...
    public static Function<
            UserPhotosStreamIdxRowResult, ImmutableSet<UserPhotosStreamIdxColumnValue>>
        getColumnValuesFun() {
      return new Function<
          UserPhotosStreamIdxRowResult, ImmutableSet<UserPhotosStreamIdxColumnValue>>() {
        @Override
        public ImmutableSet<UserPhotosStreamIdxColumnValue> apply(
            UserPhotosStreamIdxRowResult rowResult) {
  ...
  public void put(UserPhotosStreamIdxRow rowName, Iterable<UserPhotosStreamIdxColumnValue> values) {
    put(
        ImmutableMultimap.<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue>builder()
  ...
  @Override
  public void put(
      Multimap<UserPhotosStreamIdxRow, ? extends UserPhotosStreamIdxColumnValue> values) {
  ...
  public void putUnlessExists(
      UserPhotosStreamIdxRow rowName, Iterable<UserPhotosStreamIdxColumnValue> values) {
    putUnlessExists(
        ImmutableMultimap.<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue>builder()
            .putAll(rowName, values)
            .build());
  ...
  @Override
  public void putUnlessExists(
      UserPhotosStreamIdxRow rowName, UserPhotosStreamIdxColumnValue... values) {
    putUnlessExists(
        ImmutableMultimap.<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue>builder()
            .putAll(rowName, values)
            .build());
  ...
  @Override
  public void putUnlessExists(
      Multimap<UserPhotosStreamIdxRow, ? extends UserPhotosStreamIdxColumnValue> rows) {
    Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumn> toGet =
        Multimaps.transformValues(rows, UserPhotosStreamIdxColumnValue.getColumnNameFun());
    ...
    for (Entry<UserPhotosStreamIdxRow, ? extends UserPhotosStreamIdxColumnValue> entry :
        rows.entries()) {
  ...
  public void touch(Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumn> values) {
    ...
    put(currentValues);
    Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumn> toDelete =
        HashMultimap.create(values);
    for (Map.Entry<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue> e :
  ...
  public Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue> get(
    ...
    for (Entry<Cell, byte[]> e : rawResults.entrySet()) {
      if (e.getValue().length > 0) {
        UserPhotosStreamIdxRow row =
            UserPhotosStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
        UserPhotosStreamIdxColumn col =
            UserPhotosStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getColumnName());
  ...
  @Override
  public Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue> getAsync(
      final Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumn> cells,
  ...
  @Override
  public List<UserPhotosStreamIdxColumnValue> getRowColumns(
      UserPhotosStreamIdxRow row, ColumnSelection columns) {
  ...
  @Override
  public Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue> getAsyncRowsMultimap(
      Iterable<UserPhotosStreamIdxRow> rows, ExecutorService exec) {
    return getAsyncRowsMultimap(rows, allColumns, exec);
  }

  @Override
  public Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue> getAsyncRowsMultimap(
      final Iterable<UserPhotosStreamIdxRow> rows,
  ...
  private static Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue>
      getRowMapFromRowResults(Collection<RowResult<byte[]>> rowResults) {
    Multimap<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue> rowMap = HashMultimap.create();
    for (RowResult<byte[]> result : rowResults) {
      UserPhotosStreamIdxRow row =
          UserPhotosStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(result.getRowName());
  ...
  @Override
  public Map<UserPhotosStreamIdxRow, BatchingVisitable<UserPhotosStreamIdxColumnValue>>
      getRowsColumnRange(
    ...
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      UserPhotosStreamIdxRow row =
          UserPhotosStreamIdxRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
      BatchingVisitable<UserPhotosStreamIdxColumnValue> bv =
          BatchingVisitables.transform(
              e.getValue(),
              result -> {
                UserPhotosStreamIdxColumn col =
                    UserPhotosStreamIdxColumn.BYTES_HYDRATOR.hydrateFromBytes(
  ...
  @Override
  public Iterator<Map.Entry<UserPhotosStreamIdxRow, UserPhotosStreamIdxColumnValue>>
      getRowsColumnRange(
          Iterable<UserPhotosStreamIdxRow> rows,
  ...
  static String __CLASS_HASH = "/fO9XST0WZ8L57TKlp1z+w==";
}
