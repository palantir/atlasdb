...
public final class UserPhotosStreamIdxTable implements
    ...
    @Override
    public Map<UserPhotosStreamIdxRow, BatchingVisitable<UserPhotosStreamIdxColumnValue>> getRowsColumnRange(Iterable<UserPhotosStreamIdxRow> rows, SizedColumnRangeSelection columnRangeSelection) {
     ...
     * {@link ValueType}
     */
    static String __CLASS_HASH = "YX2KerFr+lsf7zy6F9R9rQ==";
}
