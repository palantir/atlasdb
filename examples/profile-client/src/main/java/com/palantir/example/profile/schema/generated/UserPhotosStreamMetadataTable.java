...
public final class UserPhotosStreamMetadataTable
  ...
  static UserPhotosStreamMetadataTable of(Transaction t, Namespace namespace) {
    return new UserPhotosStreamMetadataTable(
        t, namespace, ImmutableList.<UserPhotosStreamMetadataTrigger>of());
  }
  ...
  public interface UserPhotosStreamMetadataTrigger {
    public void putUserPhotosStreamMetadata(
        Multimap<UserPhotosStreamMetadataRow, ? extends UserPhotosStreamMetadataNamedColumnValue<?>>
            newRows);
  }
  ...
  public static final class UserPhotosStreamMetadataRowResult implements TypedRowResult {
    ...
    public static Function<UserPhotosStreamMetadataRowResult, UserPhotosStreamMetadataRow>
        getRowNameFun() {
    ...
    public static Function<RowResult<byte[]>, UserPhotosStreamMetadataRowResult>
        fromRawRowResultFun() {
  ...
  public static ColumnSelection getColumnSelection(
      Collection<UserPhotosStreamMetadataNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, UserPhotosStreamMetadataNamedColumn.toShortName()));
  }
  ...
  private static final Map<String, Hydrator<? extends UserPhotosStreamMetadataNamedColumnValue<?>>>
      shortNameToHydrator =
          ImmutableMap
              .<String, Hydrator<? extends UserPhotosStreamMetadataNamedColumnValue<?>>>builder()
  ...
  public void putUnlessExists(
      Multimap<UserPhotosStreamMetadataRow, ? extends UserPhotosStreamMetadataNamedColumnValue<?>>
          rows) {
    Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>> existing =
        getRowsMultimap(rows.keySet());
    Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>> toPut =
        HashMultimap.create();
    for (Entry<UserPhotosStreamMetadataRow, ? extends UserPhotosStreamMetadataNamedColumnValue<?>>
        entry : rows.entries()) {
  ...
  public List<UserPhotosStreamMetadataRowResult> getRows(
    ...
    List<UserPhotosStreamMetadataRowResult> rowResults =
  ...
  @Override
  public List<UserPhotosStreamMetadataRowResult> getAsyncRows(
      Iterable<UserPhotosStreamMetadataRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<UserPhotosStreamMetadataRowResult> getAsyncRows(
      final Iterable<UserPhotosStreamMetadataRow> rows,
  ...
  @Override
  public Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>
      getRowsMultimap(Iterable<UserPhotosStreamMetadataRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>
      getRowsMultimap(Iterable<UserPhotosStreamMetadataRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>
      getAsyncRowsMultimap(Iterable<UserPhotosStreamMetadataRow> rows, ExecutorService exec) {
  ...
  public Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>
    ...
    Callable<Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>> c =
        new Callable<
            Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>>() {
          @Override
          public Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>
              call() {
            return getRowsMultimapInternal(rows, columns);
  ...
  private Multimap<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>
      getRowsMultimapInternal(Iterable<UserPhotosStreamMetadataRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
  ...
  public Map<
          UserPhotosStreamMetadataRow,
          BatchingVisitable<UserPhotosStreamMetadataNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<UserPhotosStreamMetadataRow> rows,
    ...
    Map<UserPhotosStreamMetadataRow, BatchingVisitable<UserPhotosStreamMetadataNamedColumnValue<?>>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      UserPhotosStreamMetadataRow row =
          UserPhotosStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
  ...
  @Override
  public Iterator<
          Map.Entry<UserPhotosStreamMetadataRow, UserPhotosStreamMetadataNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<UserPhotosStreamMetadataRow> rows,
    ...
    return Iterators.transform(
        ...
        e -> {
          UserPhotosStreamMetadataRow row =
              UserPhotosStreamMetadataRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
          UserPhotosStreamMetadataNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "uDnrPuhLSxg9kkE/6pMw4Q==";
}
