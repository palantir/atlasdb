...
public final class UserPhotosStreamValueTable
  ...
  static UserPhotosStreamValueTable of(Transaction t, Namespace namespace) {
    return new UserPhotosStreamValueTable(
        t, namespace, ImmutableList.<UserPhotosStreamValueTrigger>of());
  }
  ...
  static UserPhotosStreamValueTable of(
    ...
    return new UserPhotosStreamValueTable(
        t,
        namespace,
        ImmutableList.<UserPhotosStreamValueTrigger>builder().add(trigger).add(triggers).build());
  }
   ...
   * </pre>
   */
  public static final class UserPhotosStreamValueRow
      implements Persistable, Comparable<UserPhotosStreamValueRow> {
  ...
  public interface UserPhotosStreamValueTrigger {
    public void putUserPhotosStreamValue(
        Multimap<UserPhotosStreamValueRow, ? extends UserPhotosStreamValueNamedColumnValue<?>>
            newRows);
  }
  ...
  public static final class UserPhotosStreamValueRowResult implements TypedRowResult {
    ...
    public static Function<UserPhotosStreamValueRowResult, UserPhotosStreamValueRow>
        getRowNameFun() {
    ...
    public static Function<RowResult<byte[]>, UserPhotosStreamValueRowResult>
        fromRawRowResultFun() {
  ...
  public static ColumnSelection getColumnSelection(
      Collection<UserPhotosStreamValueNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, UserPhotosStreamValueNamedColumn.toShortName()));
  }
  ...
  private static final Map<String, Hydrator<? extends UserPhotosStreamValueNamedColumnValue<?>>>
      shortNameToHydrator =
          ImmutableMap
              .<String, Hydrator<? extends UserPhotosStreamValueNamedColumnValue<?>>>builder()
              .put("v", Value.BYTES_HYDRATOR)
              .build();

  public Map<UserPhotosStreamValueRow, byte[]> getValues(
      Collection<UserPhotosStreamValueRow> rows) {
  ...
  @Override
  public void put(
      Multimap<UserPhotosStreamValueRow, ? extends UserPhotosStreamValueNamedColumnValue<?>> rows) {
  ...
  public void putUnlessExists(
      Multimap<UserPhotosStreamValueRow, ? extends UserPhotosStreamValueNamedColumnValue<?>> rows) {
    Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>> existing =
        getRowsMultimap(rows.keySet());
    Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>> toPut =
        HashMultimap.create();
    for (Entry<UserPhotosStreamValueRow, ? extends UserPhotosStreamValueNamedColumnValue<?>> entry :
        rows.entries()) {
  ...
  @Override
  public Optional<UserPhotosStreamValueRowResult> getRow(
  ...
  public List<UserPhotosStreamValueRowResult> getRows(
    ...
    List<UserPhotosStreamValueRowResult> rowResults =
  ...
  @Override
  public List<UserPhotosStreamValueRowResult> getAsyncRows(
      Iterable<UserPhotosStreamValueRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<UserPhotosStreamValueRowResult> getAsyncRows(
      final Iterable<UserPhotosStreamValueRow> rows,
  ...
  @Override
  public Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
      getRowsMultimap(Iterable<UserPhotosStreamValueRow> rows) {
    return getRowsMultimapInternal(rows, allColumns);
  }

  @Override
  public Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
      getRowsMultimap(Iterable<UserPhotosStreamValueRow> rows, ColumnSelection columns) {
    return getRowsMultimapInternal(rows, columns);
  }

  @Override
  public Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
      getAsyncRowsMultimap(Iterable<UserPhotosStreamValueRow> rows, ExecutorService exec) {
  ...
  public Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
    ...
    Callable<Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>> c =
        new Callable<
            Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>>() {
          @Override
          public Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
              call() {
            return getRowsMultimapInternal(rows, columns);
  ...
  private Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
      getRowsMultimapInternal(Iterable<UserPhotosStreamValueRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
    return getRowMapFromRowResults(results.values());
  }

  private static Multimap<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>
  ...
  public Map<UserPhotosStreamValueRow, BatchingVisitable<UserPhotosStreamValueNamedColumnValue<?>>>
    ...
    Map<UserPhotosStreamValueRow, BatchingVisitable<UserPhotosStreamValueNamedColumnValue<?>>>
        transformed = Maps.newHashMapWithExpectedSize(results.size());
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      UserPhotosStreamValueRow row =
          UserPhotosStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
  ...
  @Override
  public Iterator<Map.Entry<UserPhotosStreamValueRow, UserPhotosStreamValueNamedColumnValue<?>>>
      getRowsColumnRange(
    ...
    return Iterators.transform(
        ...
        e -> {
          UserPhotosStreamValueRow row =
              UserPhotosStreamValueRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
          UserPhotosStreamValueNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "occawTITP4ekOscXYr+Eog==";
}
