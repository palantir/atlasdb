...
public class UserPhotosIndexCleanupTask implements OnCleanupTask {
  ...
  public boolean cellsCleanedUp(Transaction t, Set<Cell> cells) {
    ...
    Set<UserPhotosStreamIdxTable.UserPhotosStreamIdxRow> rows =
        Sets.newHashSetWithExpectedSize(cells.size());
    for (Cell cell : cells) {
      rows.add(
          UserPhotosStreamIdxTable.UserPhotosStreamIdxRow.of(
    ...
    for (UserPhotosStreamIdxTable.UserPhotosStreamIdxRow rowToDelete :
