...
public class CachingConflictDetectionManager implements ConflictDetectionManager {
     ...
     */
    public CachingConflictDetectionManager(CacheLoader<TableReference, ConflictHandler> loader) {
