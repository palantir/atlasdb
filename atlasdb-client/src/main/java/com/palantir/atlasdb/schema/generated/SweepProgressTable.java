...
public final class SweepProgressTable implements
    ...
    @Override
    public Map<SweepProgressRow, BatchingVisitable<SweepProgressNamedColumnValue<?>>> getRowsColumnRange(Iterable<SweepProgressRow> rows, SizedColumnRangeSelection columnRangeSelection) {
