...
public final class SweepProgressTable
  ...
  private static final String rawTableName = "progress";
  private final TableReference tableRef;
  private static final ColumnSelection allColumns =
      getColumnSelection(SweepProgressNamedColumn.values());
  ...
  static SweepProgressTable of(
      Transaction t,
      Namespace namespace,
      SweepProgressTrigger trigger,
      SweepProgressTrigger... triggers) {
    return new SweepProgressTable(
        t,
        namespace,
        ImmutableList.<SweepProgressTrigger>builder().add(trigger).add(triggers).build());
  }

  static SweepProgressTable of(
      Transaction t, Namespace namespace, List<SweepProgressTrigger> triggers) {
    return new SweepProgressTable(t, namespace, triggers);
  }

  private SweepProgressTable(
      Transaction t, Namespace namespace, List<SweepProgressTrigger> triggers) {
    this.t = t;
  ...
  public static final class SweepProgressRow implements Persistable, Comparable<SweepProgressRow> {
    ...
    public static final Hydrator<SweepProgressRow> BYTES_HYDRATOR =
        new Hydrator<SweepProgressRow>() {
          @Override
    ...
    public String toString() {
      return MoreObjects.toStringHelper(getClass().getSimpleName()).add("dummy", dummy).toString();
    }
    ...
    public int compareTo(SweepProgressRow o) {
      return ComparisonChain.start().compare(this.dummy, o.dummy).result();
    }
  }
  ...
  public static final class CellsDeleted implements SweepProgressNamedColumnValue<Long> {
    ...
    public static final Hydrator<CellsDeleted> BYTES_HYDRATOR =
        new Hydrator<CellsDeleted>() {
          @Override
  ...
  public static final class CellsExamined implements SweepProgressNamedColumnValue<Long> {
    ...
    public static final Hydrator<CellsExamined> BYTES_HYDRATOR =
        new Hydrator<CellsExamined>() {
          @Override
  ...
  public static final class FullTableName implements SweepProgressNamedColumnValue<String> {
    ...
    public static final Hydrator<FullTableName> BYTES_HYDRATOR =
        new Hydrator<FullTableName>() {
          @Override
  ...
  public static final class MinimumSweptTimestamp implements SweepProgressNamedColumnValue<Long> {
    ...
    public static final Hydrator<MinimumSweptTimestamp> BYTES_HYDRATOR =
        new Hydrator<MinimumSweptTimestamp>() {
          @Override
  ...
  public static final class StartRow implements SweepProgressNamedColumnValue<byte[]> {
    ...
    public static final Hydrator<StartRow> BYTES_HYDRATOR =
        new Hydrator<StartRow>() {
          @Override
  ...
  public interface SweepProgressTrigger {
    public void putSweepProgress(
        Multimap<SweepProgressRow, ? extends SweepProgressNamedColumnValue<?>> newRows);
  }
  ...
  public static ColumnSelection getColumnSelection(Collection<SweepProgressNamedColumn> cols) {
    return ColumnSelection.create(
        Collections2.transform(cols, SweepProgressNamedColumn.toShortName()));
  }
  ...
  private static final Map<String, Hydrator<? extends SweepProgressNamedColumnValue<?>>>
      shortNameToHydrator =
  ...
  public void putFullTableName(Map<SweepProgressRow, String> map) {
    Map<SweepProgressRow, SweepProgressNamedColumnValue<?>> toPut =
  ...
  public void putUnlessExists(
      Multimap<SweepProgressRow, ? extends SweepProgressNamedColumnValue<?>> rows) {
    Multimap<SweepProgressRow, SweepProgressNamedColumnValue<?>> existing =
        getRowsMultimap(rows.keySet());
    Multimap<SweepProgressRow, SweepProgressNamedColumnValue<?>> toPut = HashMultimap.create();
    for (Entry<SweepProgressRow, ? extends SweepProgressNamedColumnValue<?>> entry :
        rows.entries()) {
  ...
  @Override
  public List<SweepProgressRowResult> getRows(
      Iterable<SweepProgressRow> rows, ColumnSelection columns) {
  ...
  @Override
  public List<SweepProgressRowResult> getAsyncRows(
      Iterable<SweepProgressRow> rows, ExecutorService exec) {
    return getAsyncRows(rows, allColumns, exec);
  }

  @Override
  public List<SweepProgressRowResult> getAsyncRows(
      final Iterable<SweepProgressRow> rows, final ColumnSelection columns, ExecutorService exec) {
  ...
  @Override
  public List<SweepProgressNamedColumnValue<?>> getRowColumns(
      SweepProgressRow row, ColumnSelection columns) {
    byte[] bytes = row.persistToBytes();
    RowResult<byte[]> rowResult = t.getRows(tableRef, ImmutableSet.of(bytes), columns).get(bytes);
    if (rowResult == null) {
      return ImmutableList.of();
    } else {
      List<SweepProgressNamedColumnValue<?>> ret =
  ...
  @Override
  public Multimap<SweepProgressRow, SweepProgressNamedColumnValue<?>> getRowsMultimap(
      Iterable<SweepProgressRow> rows) {
  ...
  @Override
  public Multimap<SweepProgressRow, SweepProgressNamedColumnValue<?>> getAsyncRowsMultimap(
      Iterable<SweepProgressRow> rows, ExecutorService exec) {
  ...
  private Multimap<SweepProgressRow, SweepProgressNamedColumnValue<?>> getRowsMultimapInternal(
      Iterable<SweepProgressRow> rows, ColumnSelection columns) {
    SortedMap<byte[], RowResult<byte[]>> results =
        t.getRows(tableRef, Persistables.persistAll(rows), columns);
  ...
  private static Multimap<SweepProgressRow, SweepProgressNamedColumnValue<?>>
  ...
  @Override
  public Map<SweepProgressRow, BatchingVisitable<SweepProgressNamedColumnValue<?>>>
      getRowsColumnRange(
          Iterable<SweepProgressRow> rows, BatchColumnRangeSelection columnRangeSelection) {
    ...
    Map<SweepProgressRow, BatchingVisitable<SweepProgressNamedColumnValue<?>>> transformed =
    ...
    for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
      ...
      BatchingVisitable<SweepProgressNamedColumnValue<?>> bv =
  ...
  @Override
  public Iterator<Map.Entry<SweepProgressRow, SweepProgressNamedColumnValue<?>>> getRowsColumnRange(
      Iterable<SweepProgressRow> rows, ColumnRangeSelection columnRangeSelection, int batchHint) {
    ...
    return Iterators.transform(
        results,
        e -> {
          SweepProgressRow row =
              SweepProgressRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey().getRowName());
          SweepProgressNamedColumnValue<?> colValue =
              shortNameToHydrator
  ...
  static String __CLASS_HASH = "aor4hzWTzZv2OoXVcxexmA==";
}
