...
public class DefaultIndexMetadata implements IndexMetadata {
    ...
    public static DefaultIndexMetadata createIndex(String name,
                                                    String javaName,
    ...
    public static DefaultIndexMetadata createDynamicIndex(String name,
                                                           String javaName,
                                                           Iterable<IndexComponent> rowComponents,
    ...
    private DefaultIndexMetadata(String name,
                          String javaName,
                          Iterable<IndexComponent> rowComponents,
                          Iterable<IndexComponent> colComponents,
    ...
    public DefaultTableMetadata getTableMetadata() {
