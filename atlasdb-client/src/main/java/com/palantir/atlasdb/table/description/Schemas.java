...
import com.palantir.atlasdb.keyvalue.impl.DelegatingDdlManager;
...
public final class Schemas {
    ...
    private static DdlManager getDdlManager(KeyValueService kvs) {
        return new DelegatingDdlManager(kvs);
    }
}
