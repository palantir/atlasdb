...
public class SweepBenchmarks {
    ...
    private Object runSingleSweep(RegeneratingTable table, int batchSize) {
        ...
        SweepResults sweepResults = sweepTaskRunner.run(table.getTableRef(), batchSize, BATCH_SIZE, null);
    ...
    private Object runMultiSweep(RegeneratingTable table) {
        ...
        for (int i = 0; i < BATCH_SIZE; i++) {
            sweepResults = sweepTaskRunner.run(table.getTableRef(), 1, BATCH_SIZE, nextStartRow);
