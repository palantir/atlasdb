...
public class TestScrubQueueMigrationCommand {
    ...
    public void testScrubQueueMigration() {
        ...
        assertThat(output.contains("Starting iteration 2")).describedAs(output).isTrue();
        assertThat(output.contains("Moved 4 cells")).describedAs(output).isTrue();
        assertThat(output.contains("into 7 cells")).describedAs(output).isTrue();
        assertThat(output.contains("Finished all iterations")).describedAs(output).isTrue();
    }
}
