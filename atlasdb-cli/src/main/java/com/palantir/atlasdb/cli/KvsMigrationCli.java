...
public class KvsMigrationCli {

    private static Cli<Callable> buildCli() {
        Cli.CliBuilder<Callable> builder = Cli.<Callable>builder("kvsMigrate")
                .withDescription("Migrate your data from one key value service to another.")
                .withDefaultCommand(Help.class)
                .withCommands(Help.class, KvsMigrationCommand.class);
