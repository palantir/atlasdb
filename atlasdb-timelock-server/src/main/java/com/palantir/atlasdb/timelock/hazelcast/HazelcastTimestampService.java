...
public class HazelcastTimestampService implements TimestampService {
    ...
    private final TimestampGetter timestamp;

    public HazelcastTimestampService(TimestampGetter timestamp) {
    ...
    public TimestampRange getFreshTimestamps(int numTimestampsRequested) {
        ...
        long lastTimestampHandedOut = timestamp.getAndAdd(numTimestampsRequested);
