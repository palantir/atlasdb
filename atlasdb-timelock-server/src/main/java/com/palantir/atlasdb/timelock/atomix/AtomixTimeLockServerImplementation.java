...
public class AtomixTimeLockServerImplementation implements TimeLockServerImplementation {
    private static final Logger log = LoggerFactory.getLogger(AtomixTimeLockServerImplementation.class);
