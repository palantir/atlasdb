...
public abstract class AbstractDbKvsKeyValueServiceTestV2 extends AbstractKeyValueServiceTestV2 {
    ...
    public AbstractDbKvsKeyValueServiceTestV2(KvsManager kvsManager) {
        super(kvsManager);
    }
