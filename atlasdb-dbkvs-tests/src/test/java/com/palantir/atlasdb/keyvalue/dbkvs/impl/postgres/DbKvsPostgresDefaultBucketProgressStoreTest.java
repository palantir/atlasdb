...
public class DbKvsPostgresDefaultBucketProgressStoreTest extends AbstractDefaultBucketProgressStoreTest {
    @RegisterExtension
    public static final TestResourceManager TRM = new TestResourceManager(DbKvsPostgresExtension::createKvs);

    public DbKvsPostgresDefaultBucketProgressStoreTest() {
        super(TRM);
    }
}
