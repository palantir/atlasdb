...
//    private ServiceConfiguration mockCassandraServiceConfig;
//
//    @Before
//    public void before() {
//        when(config.get()).thenReturn(configWithLimits(ImmutableMap.of()));
//        when(mockCassandraServiceConfig.security()).thenReturn();
...
//        return ImmutableQosServiceRuntimeConfig.builder().clientLimits(limits)
