...
public class QosClientConfigLoader {
    private static final QosClientLimitsConfig DEFAULT_LIMITS = ImmutableQosClientLimitsConfig.builder().build();
    ...
    public QosClientLimitsConfig getConfigForClient(String client) {
        return qosClientLimitsConfigSupplier.get().getOrDefault(client, DEFAULT_LIMITS);
    }
}
