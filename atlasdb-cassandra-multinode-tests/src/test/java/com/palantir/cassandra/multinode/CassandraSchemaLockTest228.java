...
public class CassandraSchemaLockTest228 extends CassandraSchemaLockTest {
    ...
    @ClassRule
    public static final Containers CONTAINERS = new Containers(CassandraSchemaLockTest228.class, dockerMachine)
