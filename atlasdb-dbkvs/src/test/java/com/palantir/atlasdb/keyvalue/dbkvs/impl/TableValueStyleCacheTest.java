...
public class TableValueStyleCacheTest {
    ...
    public void testGetTableSizeOneTimeHasCacheMiss() throws Exception {
        assertThat(valueStyleCache.getTableType(connectionSupplier, TEST_TABLE, AtlasDbConstants.DEFAULT_METADATA_TABLE)).isEqualTo(TableValueStyle.OVERFLOW);
    ...
    public void testCacheHandlesMultipleTableRequests() throws Exception {
        assertThat(valueStyleCache.getTableType(connectionSupplier, TEST_TABLE, AtlasDbConstants.DEFAULT_METADATA_TABLE)).isEqualTo(TableValueStyle.OVERFLOW);
        assertThat(valueStyleCache.getTableType(connectionSupplier, TEST_TABLE_2, AtlasDbConstants.DEFAULT_METADATA_TABLE)).isEqualTo(TableValueStyle.OVERFLOW);
