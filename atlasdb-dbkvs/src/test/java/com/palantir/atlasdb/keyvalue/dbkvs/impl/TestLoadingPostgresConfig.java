...
public class TestLoadingPostgresConfig {
    @Test
    ...
    public void testPasswordIsMasked() throws IOException {
        ConnectionConfig connectionConfig = getConnectionConfig();
        assertThat(connectionConfig.getDbPassword().unmasked(), equalTo("palpal"));
        assertThat(connectionConfig.getHikariProperties().getProperty("password"), equalTo("palpal"));
        assertThat(connectionConfig.toString(), not(containsString("palpal")));
