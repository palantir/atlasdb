...
do
  cat "$TEMPLATE_DIR/$config" | sed "s/SERVER1/$SERVER1/g" | sed "s/SERVER2/$SERVER2/g" | sed "s/SERVER3/$SERVER3/g" | sed "s/KEYSTORE_PASSWORD/$KEYSTORE_PASSWORD/g" > "$RENDERED_DIR/$config"
done
