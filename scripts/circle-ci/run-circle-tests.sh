...
CONTAINER_5=(':lock-impl:check' ':atlasdb-dbkvs-tests:postgresTest' ':atlasdb-ete-test-utils:check' ':atlasdb-ete-tests:singleClientWithEmbeddedAndThreeNodeCassandraTest')
...
case "$test_suite_index" in
    ...
    2) ./gradlew $BASE_GRADLE_ARGS ${CONTAINER_2[@]} -x :atlasdb-ete-tests:singleClientWithEmbeddedAndThreeNodeCassandraTest -x atlasdb-ete-tests:singleClientWithEmbeddedAndPostgresTest -x :atlasdb-ete-tests:timeLockMigrationTest ;;
