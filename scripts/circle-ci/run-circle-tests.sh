...
CONTAINER_1=(':atlasdb-ete-tests:dbkvs')
CONTAINER_2=(':atlasdb-ete-tests:dbkvs')
CONTAINER_3=(':atlasdb-ete-tests:dbkvs')
CONTAINER_4=(':atlasdb-ete-tests:dbkvs')
CONTAINER_5=(':atlasdb-ete-tests:dbkvs')
CONTAINER_6=(':atlasdb-ete-tests:dbkvs')
CONTAINER_7=(':atlasdb-ete-tests:dbkvs')
