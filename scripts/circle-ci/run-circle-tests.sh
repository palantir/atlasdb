...
case $CIRCLE_NODE_INDEX in
    ...
    7) ./gradlew $BASE_GRADLE_ARGS ${CONTAINER_7[@]} -PenableErrorProne=false && checkDocsBuild ;; # errorprone has moved the goalposts underneath us, and backporting the refactor looks messy
esac
