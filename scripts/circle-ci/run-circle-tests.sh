...
CONTAINER_3=(':atlasdb-dbkvs:check' ':atlasdb-cassandra:check' ':timelock-server:integTest' 'atlasdb-dbkvs-tests:oracleTest')
...
if [ $CIRCLE_NODE_INDEX -eq 3 ] || [ $CIRCLE_NODE_INDEX -eq 9 ]; then
