...
#Container 3
CONTAINER_3=(':atlasdb-timelock-ete:check' ':lock-impl:check' ':atlasdb-dbkvs-tests:check' ':atlasdb-tests-shared:check' ':atlasdb-ete-test-utils:check' ':atlasdb-cassandra:check' ':atlasdb-api:check' ':atlasdb-dropwizard-bundle:check' ':atlasdb-config:check' ':atlasdb-perf:check' ':atlasdb-dagger:check' ':atlasdb-cli:check' ':atlasdb-jdbc:check')
