...
docker pull palantirtechnologies/cassandra:2.2.18-1.143.0-rc5
docker tag palantirtechnologies/cassandra:2.2.18-1.143.0-rc5 ${ANTITHESIS_REPO_URL}/cassandra:${EXPECTED_ANTITHESIS_TAG}
