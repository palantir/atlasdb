...
public class SecondCassandraContainer extends Container {
    ...
    public static final InetSocketAddress server = new InetSocketAddress("cassandra2", CASSANDRA_PORT);
    ...
    public String getDockerComposeFile() {
        return "/docker-compose-cassandra2.yml";
    }
