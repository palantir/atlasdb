...
public interface Transaction {
     ...
     * <p>
     * In the event that local writes are performed to cells that would fall in the range of columns indicated for one
     * (or more) of the provided rows, behaviour is undefined.
     * <p>
