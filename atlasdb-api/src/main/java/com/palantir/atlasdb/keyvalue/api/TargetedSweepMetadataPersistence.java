...
public final class TargetedSweepMetadataPersistence {
    ...
    private TargetedSweepMetadataPersistence() {}
    ...
    public static byte[] persistToBytes(
            boolean conservative,
            boolean dedicatedRow,
            int shard,
            long dedicatedRowNumber,
            boolean nonSweepableTransaction) {
