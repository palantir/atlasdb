...
public interface CandidateCellForSweeping {
     ...
     *
     * Note that this will be null if and only if {@link #isCandidate()} is false.
     */
    @Nullable
    ...
    /**
     * Will be false when the cell is not an actual candidate and is only returned for the purpose of
     * reporting the nubmer of examined cells.
     */
    boolean isCandidate();
