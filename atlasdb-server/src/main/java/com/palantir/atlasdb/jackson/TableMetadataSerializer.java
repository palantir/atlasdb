...
public class TableMetadataSerializer extends StdSerializer<TableMetadata> {
    ...
    @Override
    public void serialize(TableMetadata value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonGenerationException {
    ...
    private void serialize(JsonGenerator jgen, NameMetadataDescription rowMetadata) throws IOException, JsonProcessingException {
    ...
    private void serialize(JsonGenerator jgen, Descriptor descriptor) throws IOException, JsonProcessingException {
    ...
    private void serialize(JsonGenerator jgen, FieldDescriptor field) throws IOException, JsonProcessingException {
    ...
    private void serialize(JsonGenerator jgen, EnumDescriptor enumType) throws IOException, JsonProcessingException {
