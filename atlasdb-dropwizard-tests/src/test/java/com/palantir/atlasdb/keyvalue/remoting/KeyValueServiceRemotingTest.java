...
public class KeyValueServiceRemotingTest extends AbstractAtlasDbKeyValueServiceTest {
    ...
    public void testSerialize() throws IOException {
        ...
        RemoteRowColumnRangeIterator rowColumnRangeIterator = new RemoteRowColumnRangeIterator(TableReference.create(Namespace.create("ns"), "test_table"),
                new SizedColumnRangeSelection(PtBytes.EMPTY_BYTE_ARRAY, PtBytes.EMPTY_BYTE_ARRAY, 1), 100L, true,
        ...
        rowColumnRangeIterator = new RemoteRowColumnRangeIterator(TableReference.create(Namespace.create("ns"), "test_table"),
                new SizedColumnRangeSelection(PtBytes.EMPTY_BYTE_ARRAY, PtBytes.EMPTY_BYTE_ARRAY, 1), 100L, false,
                ImmutableList.of());
