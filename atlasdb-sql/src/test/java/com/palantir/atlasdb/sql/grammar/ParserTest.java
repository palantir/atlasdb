...
public class ParserTest {
    ...
    public void testSelectClause() {
        AtlasSQLLexer lexer = new AtlasSQLLexer(new ANTLRInputStream("SELECT col1, col2 FROM table WHERE col3 = 50 AND col4 BETWEEN 10 AND 20".toLowerCase()));
        ...
        Preconditions.checkState(select.table_name().getText().equals("table"));
