...
public class KvsWritePerfTest extends AbstractBenchmark {
    ...
    public static Map<String, Object> execute(SerializableTransactionManager txnManager, int numClients,
        ...
        return new KvsWritePerfTest(txnManager.getKeyValueService(), numClients, requestsPerClient).execute();
    }

    private KvsWritePerfTest(KeyValueService keyValueService, int numClients, int numRequestsPerClient) {
