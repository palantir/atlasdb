...
public class KvsReadPerfTest extends AbstractBenchmark {
    ...
    public static Map<String, Object> execute(SerializableTransactionManager txnManager, int numClients,
        ...
        return new KvsReadPerfTest(txnManager.getKeyValueService(), numClients, requestsPerClient).execute();
    }

    private KvsReadPerfTest(KeyValueService keyValueService, int numClients, int numRequestsPerClient) {
