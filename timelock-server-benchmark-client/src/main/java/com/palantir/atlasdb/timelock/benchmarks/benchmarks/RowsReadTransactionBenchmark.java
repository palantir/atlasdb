...
public class RowsReadTransactionBenchmark extends AbstractBenchmark {
    ...
    private RowsReadTransactionBenchmark(TransactionManager txnManager, int numClients, int requestsPerClient, int numRows, int dataSize) {
