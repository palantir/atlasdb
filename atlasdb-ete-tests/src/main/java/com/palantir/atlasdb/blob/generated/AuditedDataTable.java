...
public final class AuditedDataTable implements
        AtlasDbMutablePersistentTable<AuditedDataTable.AuditedDataRow,
                                         ...
                                         AuditedDataTable.AuditedDataRowResult>,
        AtlasDbNamedMutableTable<AuditedDataTable.AuditedDataRow,
                                    AuditedDataTable.AuditedDataNamedColumnValue<?>,
                                    AuditedDataTable.AuditedDataRowResult> {
    ...
    static AuditedDataTable of(Transaction t, Namespace namespace, AuditedDataTrigger trigger, AuditedDataTrigger... triggers) {
        return new AuditedDataTable(t, namespace, ImmutableList.<AuditedDataTrigger>builder().add(trigger).add(triggers).build());
    }

    static AuditedDataTable of(Transaction t, Namespace namespace, List<AuditedDataTrigger> triggers) {
        return new AuditedDataTable(t, namespace, triggers);
    }
     ...
     * </pre>
     */
    public static final class AuditedDataRow implements Persistable, Comparable<AuditedDataRow> {
        private final long id;

        public static AuditedDataRow of(long id) {
            return new AuditedDataRow(id);
        }

        private AuditedDataRow(long id) {
            this.id = id;
        }
        ...
        public static Function<AuditedDataRow, Long> getIdFun() {
            return new Function<AuditedDataRow, Long>() {
                @Override
                public Long apply(AuditedDataRow row) {
                    return row.id;
                }
            };
        }

        public static Function<Long, AuditedDataRow> fromIdFun() {
            return new Function<Long, AuditedDataRow>() {
                @Override
                public AuditedDataRow apply(Long row) {
                    return AuditedDataRow.of(row);
                }
            };
        }
        ...
        public static final Hydrator<AuditedDataRow> BYTES_HYDRATOR = new Hydrator<AuditedDataRow>() {
            @Override
            public AuditedDataRow hydrateFromBytes(byte[] _input) {
                int _index = 0;
        ...
        public boolean equals(Object obj) {
            ...
            AuditedDataRow other = (AuditedDataRow) obj;
        ...
        @Override
        public int compareTo(AuditedDataRow o) {
    ...
    public interface AuditedDataNamedColumnValue<T> extends NamedColumnValue<T> { /* */ }
     ...
     * </pre>
     */
    public static final class Data implements AuditedDataNamedColumnValue<byte[]> {
    ...
    public interface AuditedDataTrigger {
        public void putAuditedData(Multimap<AuditedDataRow, ? extends AuditedDataNamedColumnValue<?>> newRows);
    }

    public static final class AuditedDataRowResult implements TypedRowResult {
        private final RowResult<byte[]> row;

        public static AuditedDataRowResult of(RowResult<byte[]> row) {
            return new AuditedDataRowResult(row);
        }

        private AuditedDataRowResult(RowResult<byte[]> row) {
            this.row = row;
        }

        @Override
        public AuditedDataRow getRowName() {
            return AuditedDataRow.BYTES_HYDRATOR.hydrateFromBytes(row.getRowName());
        }

        public static Function<AuditedDataRowResult, AuditedDataRow> getRowNameFun() {
            return new Function<AuditedDataRowResult, AuditedDataRow>() {
                @Override
                public AuditedDataRow apply(AuditedDataRowResult rowResult) {
                    return rowResult.getRowName();
                }
            };
        }

        public static Function<RowResult<byte[]>, AuditedDataRowResult> fromRawRowResultFun() {
            return new Function<RowResult<byte[]>, AuditedDataRowResult>() {
                @Override
                public AuditedDataRowResult apply(RowResult<byte[]> rowResult) {
                    return new AuditedDataRowResult(rowResult);
                }
            };
        }
        ...
        public static Function<AuditedDataRowResult, byte[]> getDataFun() {
            return new Function<AuditedDataRowResult, byte[]>() {
                @Override
                public byte[] apply(AuditedDataRowResult rowResult) {
    ...
    public enum AuditedDataNamedColumn {
        DATA {
            @Override
        ...
        public static Function<AuditedDataNamedColumn, byte[]> toShortName() {
            return new Function<AuditedDataNamedColumn, byte[]>() {
                @Override
                public byte[] apply(AuditedDataNamedColumn namedColumn) {
    ...
    private static final Map<String, Hydrator<? extends AuditedDataNamedColumnValue<?>>> shortNameToHydrator =
            ImmutableMap.<String, Hydrator<? extends AuditedDataNamedColumnValue<?>>>builder()
    ...
    public void putData(AuditedDataRow row, byte[] value) {
        put(ImmutableMultimap.of(row, Data.of(value)));
    }

    public void putData(Map<AuditedDataRow, byte[]> map) {
    ...
    public void deleteData(Iterable<AuditedDataRow> rows) {
    ...
    @Override
    public void delete(AuditedDataRow row) {
    ...
    public Optional<AuditedDataRowResult> getRow(AuditedDataRow row, ColumnSelection columns) {
        ...
        if (rowResult == null) {
            ...
            return Optional.of(AuditedDataRowResult.of(rowResult));
        }
    }
    ...
    @Override
    public List<AuditedDataRowResult> getRows(Iterable<AuditedDataRow> rows, ColumnSelection columns) {
        SortedMap<byte[], RowResult<byte[]>> results = t.getRows(tableRef, Persistables.persistAll(rows), columns);
        List<AuditedDataRowResult> rowResults = Lists.newArrayListWithCapacity(results.size());
        for (RowResult<byte[]> row : results.values()) {
            rowResults.add(AuditedDataRowResult.of(row));
        }
        return rowResults;
    }
    ...
    @Override
    public List<AuditedDataNamedColumnValue<?>> getRowColumns(AuditedDataRow row, ColumnSelection columns) {
        byte[] bytes = row.persistToBytes();
        RowResult<byte[]> rowResult = t.getRows(tableRef, ImmutableSet.of(bytes), columns).get(bytes);
        if (rowResult == null) {
            return ImmutableList.of();
        } else {
            List<AuditedDataNamedColumnValue<?>> ret = Lists.newArrayListWithCapacity(rowResult.getColumns().size());
    ...
    @Override
    public Multimap<AuditedDataRow, AuditedDataNamedColumnValue<?>> getRowsMultimap(Iterable<AuditedDataRow> rows, ColumnSelection columns) {
        return getRowsMultimapInternal(rows, columns);
    }

    private Multimap<AuditedDataRow, AuditedDataNamedColumnValue<?>> getRowsMultimapInternal(Iterable<AuditedDataRow> rows, ColumnSelection columns) {
        SortedMap<byte[], RowResult<byte[]>> results = t.getRows(tableRef, Persistables.persistAll(rows), columns);
    ...
    @Override
    public Map<AuditedDataRow, BatchingVisitable<AuditedDataNamedColumnValue<?>>> getRowsColumnRange(Iterable<AuditedDataRow> rows, BatchColumnRangeSelection columnRangeSelection) {
        Map<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> results = t.getRowsColumnRange(tableRef, Persistables.persistAll(rows), columnRangeSelection);
        Map<AuditedDataRow, BatchingVisitable<AuditedDataNamedColumnValue<?>>> transformed = Maps.newHashMapWithExpectedSize(results.size());
        for (Entry<byte[], BatchingVisitable<Map.Entry<Cell, byte[]>>> e : results.entrySet()) {
            AuditedDataRow row = AuditedDataRow.BYTES_HYDRATOR.hydrateFromBytes(e.getKey());
            BatchingVisitable<AuditedDataNamedColumnValue<?>> bv = BatchingVisitables.transform(e.getValue(), result -> {
    ...
    public BatchingVisitableView<AuditedDataRowResult> getAllRowsUnordered(ColumnSelection columns) {
        return BatchingVisitables.transform(t.getRange(tableRef, RangeRequest.builder()
            ...
            public AuditedDataRowResult apply(RowResult<byte[]> input) {
                return AuditedDataRowResult.of(input);
            }
        });
    }
