...
public final class HotspottyDataStreamHashAidxTable implements
    ...
    public void delete(Iterable<HotspottyDataStreamHashAidxRow> rows) {
        Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumn> toRemove = HashMultimap.of();
    ...
    public void putUnlessExists(Multimap<HotspottyDataStreamHashAidxRow, ? extends HotspottyDataStreamHashAidxColumnValue> rows) {
        ...
        Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumnValue> toPut = HashMultimap.of();
    ...
    public void touch(Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumn> values) {
        ...
        put(currentValues);
        Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumn> toDelete = HashMultimap.of(values);
    ...
    public Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumnValue> get(Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumn> cells) {
        ...
        Multimap<HotspottyDataStreamHashAidxRow, HotspottyDataStreamHashAidxColumnValue> rowMap = HashMultimap.of();
     ...
     * {@link ValueType}
     */
    static String __CLASS_HASH = "LfPoJNBcBIdH4wDpx5Ltdw==";
}
