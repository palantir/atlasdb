...
import com.palantir.atlasdb.illiteracy.SimpleRowWatchResource;
import com.palantir.atlasdb.illiteracy.SimpleRowWatchResource2;
...
public class AtlasDbEteServer extends Application<AtlasDbEteConfiguration> {
    ...
    public void run(AtlasDbEteConfiguration config, final Environment environment) throws Exception {
        ...
        environment.jersey().register(SimpleRowWatchResource.create(txManager));
        environment.jersey().register(SimpleRowWatchResource2.create(txManager));
    }
