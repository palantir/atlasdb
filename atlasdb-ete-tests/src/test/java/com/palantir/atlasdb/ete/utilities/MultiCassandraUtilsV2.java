...
public final class MultiCassandraUtilsV2 {
    public static final int CASSANDRA_THRIFT_PORT = 9160;

    private MultiCassandraUtilsV2() {
        // utility
    }
    ...
    public static void resetCassandraCluster(Set<String> containerNames) {
        containerNames.forEach(MultiCassandraUtilsV2::killCassandraContainer);
        containerNames.forEach(MultiCassandraUtilsV2::startCassandraContainer);
    }
