...
public class CassandraTimeLockDialogueTestSuite extends EteSetup {
    ...
    public static final RuleChain COMPOSITION_SETUP = EteSetup.setupCompositionWithTimelock(
            CassandraTimeLockDialogueTestSuite.class,
            "docker-compose.timelock-dialogue.cassandra.yml",
            CLIENTS,
