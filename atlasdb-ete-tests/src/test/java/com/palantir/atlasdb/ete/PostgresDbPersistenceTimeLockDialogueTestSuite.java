...
public class PostgresDbPersistenceTimeLockDialogueTestSuite extends EteSetup {
    ...
    public static final RuleChain COMPOSITION_SETUP = EteSetup.setupCompositionWithTimelock(
            PostgresDbPersistenceTimeLockDialogueTestSuite.class,
            "docker-compose.timelock-dialogue.database.bound.postgres.yml",
            CLIENTS,
            ImmutableMap.of());
}
