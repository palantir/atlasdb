...
public final class AsyncLockClient implements JepsenLockClient<LockToken> {
    ...
    private AsyncLockClient(NamespaceAwareTimelockRpcClient timelockService) {
    ...
    public static AsyncLockClient create(MetricRegistry metricRegistry, List<String> hosts) {
        return new AsyncLockClient(TimelockUtils.createClient(metricRegistry, hosts, NamespaceAwareTimelockRpcClient.class));
    }
