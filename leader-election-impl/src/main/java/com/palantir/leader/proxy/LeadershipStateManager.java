...
public class LeadershipStateManager<T> {
    private static final SafeLogger log = SafeLoggerFactory.get(LeadershipStateManager.class);
     ...
     */
    NotCurrentLeaderException handleNotLeading(final LeadershipToken leadershipToken, @Nullable Throwable cause) {
