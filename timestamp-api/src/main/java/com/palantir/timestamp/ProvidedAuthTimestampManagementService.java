...
public class ProvidedAuthTimestampManagementService implements TimestampManagementService {
    ...
    public void fastForwardTimestamp(long currentTimestamp) {
        authedTimestampManagementService.fastForwardTimestamp(authHeaderSupplier.get(), currentTimestamp);
    }

    @Override
    public String ping() {
        return authedTimestampManagementService.ping(authHeaderSupplier.get());
    }
}
