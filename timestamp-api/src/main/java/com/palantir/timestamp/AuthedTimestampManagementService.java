...
public interface AuthedTimestampManagementService {
    ...
    void fastForwardTimestamp(@HeaderParam(HttpHeaders.AUTHORIZATION) AuthHeader authHeader,
    ...
    String ping(@HeaderParam(HttpHeaders.AUTHORIZATION) AuthHeader authHeader);
}
