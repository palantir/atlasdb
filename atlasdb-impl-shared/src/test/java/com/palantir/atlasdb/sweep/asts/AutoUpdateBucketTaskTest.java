...
public final class AutoUpdateBucketTaskTest {
    ...
    // TODO: Consider having a start method.
    private final AutoUpdateBucketTask taskRunner = AutoUpdateBucketTask.create(scheduler, taskDelay, task);

    @Test
    public void runsFirstTaskAfterInitialDelay() {
