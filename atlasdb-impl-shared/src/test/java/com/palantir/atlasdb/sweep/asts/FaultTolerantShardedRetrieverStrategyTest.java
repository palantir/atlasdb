...
public class FaultTolerantShardedRetrieverStrategyTest {
    ...
    @Mock
    private ShardedRetrieverStrategy delegate;

    @Mock
    private Consumer<ShardAndStrategy> failureTracker;

    private ShardedRetrieverStrategy strategy;

    @BeforeEach
    public void setup() {
        strategy = FaultTolerantShardedRetrieverStrategy.create(delegate, failureTracker, _duration -> {});
    }
