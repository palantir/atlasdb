...
public class SweepBatchWithPartitionInfoTest {
    ...
    @Test
    public void includesValuesFromPreviousPartitions() {
        ...
        assertThat(batchWithPartitionInfo.partitionsForPreviousLastSweptTs(SweepQueueUtils.maxTsForFinePartition(66L)))
                .containsExactlyInAnyOrder(66L, 67L);
    }

    @Test
    public void doesNotIncludeValuesFromPreviousPartitionsIfBelowMinimumBound() {
        when(batch.lastSweptTimestamp()).thenReturn(SweepQueueUtils.maxTsForFinePartition(67L));
        SweepBatchWithPartitionInfo batchWithPartitionInfo =
                SweepBatchWithPartitionInfo.of(batch, ImmutableSet.of(67L));
        assertThat(batchWithPartitionInfo.partitionsForPreviousLastSweptTsWithMinimumBound(
                        SweepQueueUtils.maxTsForFinePartition(66L), SweepQueueUtils.minTsForFinePartition(67L)))
