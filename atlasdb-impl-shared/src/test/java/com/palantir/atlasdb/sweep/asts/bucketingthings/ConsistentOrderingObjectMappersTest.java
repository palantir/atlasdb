...
public final class ConsistentOrderingObjectMappersTest {
    private static final ObjectMapper JSON_OBJECT_MAPPER =
            ConsistentOrderingObjectMappers.configureConsistentOrderingObjectMapper(
                    ObjectMappers.newClientJsonMapper());

    private static final TestObject ALL_PARAMS = ImmutableTestObject.builder()
            .b("test")
            .a(true)
            .a123(123)
            .putMapMapMapMenMen("b", "jay")
            .putMapMapMapMenMen("a", "mark")
            .build();
    private static final TestObject EMPTY_OPTIONAL = ImmutableTestObject.builder()
            ...
            .putMapMapMapMenMen("a", "mark")
            .build();
    private static final TestObject NULL_VALUE = ImmutableTestObject.builder()
            .b(null)
            .a(true)
            .a123(123)
            .putMapMapMapMenMen("b", "jay")
    ...
    // In this case, the 0 / empty map field will not be serialised, but then deserialisation fails because the value is
    // not present
    private static final TestObject EMPTY_MAP_ZERO_INT =
    ...
    private static final Map<TestObject, String> GOLDEN_JSON = ImmutableMap.of(
            ALL_PARAMS,
                    // alphabetical fields and map keys
                    "{\"a\":true,\"a123\":123,\"b\":\"test\",\"mapMapMapMenMen\":{\"a\":\"mark\",\"b\":\"jay\"}}",
            EMPTY_OPTIONAL,
                    // optional not serialised
                    "{\"a123\":123,\"b\":\"test\",\"mapMapMapMenMen\":{\"a\":\"mark\",\"b\":\"jay\"}}",
            NULL_VALUE,
                    // null not serialised
                    "{\"a\":true,\"a123\":123,\"mapMapMapMenMen\":{\"a\":\"mark\",\"b\":\"jay\"}}",
            EMPTY_MAP_ZERO_INT,
                    // 0/map is still serialised
                    "{\"a\":true,\"a123\":0,\"b\":\"test\",\"mapMapMapMenMen\":{}}");
    ...
    private static final Map<TestObject, byte[]> GOLDEN_SMILE = ImmutableMap.of(
            ALL_PARAMS,
                    BaseEncoding.base64()
                            .decode("OikKBfqAYSODYTEyMyQDtoBiQ3Rlc3SObWFwTWFwTWFwTWVuTWVu+kBDbWFya0JCamF5+/s="),
            EMPTY_OPTIONAL,
                    BaseEncoding.base64()
                            .decode("OikKBfqDYTEyMyQDtoBiQ3Rlc3SObWFwTWFwTWFwTWVuTWVu+oBhQ21hcmtBQmphefv7"),
            NULL_VALUE,
                    BaseEncoding.base64().decode("OikKBfqAYSODYTEyMyQDto5tYXBNYXBNYXBNZW5NZW76QENtYXJrgGJCamF5+/s="),
            EMPTY_MAP_ZERO_INT,
                    BaseEncoding.base64().decode("OikKBfqAYSODYTEyM8CAYkN0ZXN0jm1hcE1hcE1hcE1lbk1lbvr7+w=="));
    ...
    public void smileMapperEmitsConsistentSmile(TestObject exampleObject, byte[] expectedSmile)
            throws JsonProcessingException {
        assertThat(ConsistentOrderingObjectMappers.OBJECT_MAPPER.writeValueAsBytes(exampleObject))
    ...
    public void smileMapperCanDeserialiseOldValues(TestObject exampleObject, byte[] expectedSmile) throws IOException {
        assertThat(ConsistentOrderingObjectMappers.OBJECT_MAPPER.readValue(expectedSmile, TestObject.class))
    ...
    public void smileMapperCanIgnoreUnknownValues() throws IOException {
        SuperSetTestObject superSetTestObject = ImmutableSuperSetTestObject.builder()
                ...
                .mapMapMapMenMen(ImmutableMap.of("z", "test", "y", "hello"))
                .build();

        TestObject expectedTestObject = ImmutableTestObject.builder()
                .a(true)
                .a123(123)
                .b("test")
                .mapMapMapMenMen(ImmutableMap.of("y", "hello", "z", "test"))
                .build();

        byte[] smile = ConsistentOrderingObjectMappers.OBJECT_MAPPER.writeValueAsBytes(superSetTestObject);
        TestObject deserialised = ConsistentOrderingObjectMappers.OBJECT_MAPPER.readValue(smile, TestObject.class);
    ...
    interface TestObject {
        ...
        Map<String, String> mapMapMapMenMen();
    }
