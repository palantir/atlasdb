...
public final class CoordinationAwareKnownConcludedTransactionsStoreTest {
    ...
    public void supplementThrows() {
        ...
        Range<Long> rangeToSupplement = Range.closedOpen(100L, 200L);
        coordinationAwareStore.addConcludedTimestamps(rangeToSupplement);
        verify(delegate).addConcludedTimestamps(ImmutableSet.of(Range.closedOpen(100L, 200L)));
    }
