...
public abstract class InternalSchemaMetadataState {
    ...
    public static InternalSchemaMetadataState of(ValueAndBound<InternalSchemaMetadata> value) {
        return ImmutableInternalSchemaMetadataState.builder().value(value).build();
    }
}
