...
public final class DefaultReadValidator implements ReadValidator {
    ...
    @Override
    public boolean requiresImmutableTimestampLocking(TableReference tableRef, boolean allPossibleCellsReadAndPresent) {
