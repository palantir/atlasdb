...
public interface KeyValueServiceDataTracker {
     ...
     */
    void recordReadForTable(TableReference tableRef, String methodName, long bytesRead);

    /**
     * Tracks a fully resolved (i.e., non-lazy) Atlas KVS read with no {@link TableReference} information.
     */
    void recordTableAgnosticRead(String methodName, long bytesRead);
     ...
     */
    BytesReadTracker recordCallForTable(TableReference tableRef);
}
