...
public final class KnownConcludedTransactionsImpl implements KnownConcludedTransactions {
    ...
    private KnownConcludedTransactionsImpl(
            ...
            KnownConcludedTransactionsMetrics knownConcludedTransactionsMetrics) {
        ...
        this.knownConcludedTransactionsMetrics = knownConcludedTransactionsMetrics;
        this.knownConcludedTransactionsMetrics.disjointCacheIntervals(
