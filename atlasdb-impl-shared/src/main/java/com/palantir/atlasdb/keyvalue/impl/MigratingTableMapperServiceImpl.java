...
public class MigratingTableMapperServiceImpl implements MigratingTableMapperService {
    ...
    private final ImmutableTimestampSupplier immutableTsSupplier;

    public MigratingTableMapperServiceImpl(Set<TableReference> tablesToMigrate, ImmutableTimestampSupplier immutableTsSupplier) {
