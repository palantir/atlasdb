...
public final class InsufficientConsistencyExceptionMapper implements
        ExceptionMapper<InsufficientConsistencyException> {

    private static final InsufficientConsistencyExceptionMapper instance = new InsufficientConsistencyExceptionMapper();
