...
public interface NamespacedKeyValueService {
    ...
    @Idempotent
    Map<byte[], RowColumnRangeIterator> getRowsColumnRange(TableReference tableRef, Iterable<byte[]> rows, SizedColumnRangeSelection columnRangeSelection, long timestamp);
