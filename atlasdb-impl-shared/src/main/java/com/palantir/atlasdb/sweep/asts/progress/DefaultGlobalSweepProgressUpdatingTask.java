...
public class DefaultGlobalSweepProgressUpdatingTask implements GlobalSweepProgressUpdatingTask {
    ...
    private final ShardProgressUpdateProposer shardProgressUpdateProposer;
    ...
    public DefaultGlobalSweepProgressUpdatingTask(
            ...
            ShardProgressUpdateProposer shardProgressUpdateProposer,
            SweepQueueCleaner sweepQueueCleaner) {
        this.sweepTimestampSupplier = sweepTimestampSupplier;
        this.shardProgressUpdateProposer = shardProgressUpdateProposer;
    ...
    public void updateProgress(ShardAndStrategy shardAndStrategy) {
        ...
        ShardProgressUpdate progressUpdate = shardProgressUpdateProposer.proposeUpdate(currentSweepTimestamp);
        // Deferring to today's cleaner.
        sweepQueueCleaner.backgroundClean(
                shardAndStrategy, progressUpdate.completedFinePartitions(), progressUpdate.progressTimestamp());
    }
}
