...
public final class DefaultShardedRetrieverStrategy implements ShardedRetrieverStrategy {
    private final Refreshable<Integer> bucketLimit;
    private final SweepableTimestamps sweepableTimestamps;

    private DefaultShardedRetrieverStrategy(Refreshable<Integer> bucketLimit, SweepableTimestamps sweepableTimestamps) {
    ...
    public static ShardedRetrieverStrategy create(
        ...
        return new DefaultShardedRetrieverStrategy(bucketLimit, sweepableTimestamps);
    }
