...
docker tag palantirtechnologies/timelock-server-distribution:${VERSION} palantirtechnologies/timelock-server-distribution:${EXPECTED_ANTITHESIS_TEST_TAG}
docker tag palantirtechnologies/atlasdb-workload-server-distribution:${VERSION} palantirtechnologies/atlasdb-workload-server-distribution:${EXPECTED_ANTITHESIS_TEST_TAG}
